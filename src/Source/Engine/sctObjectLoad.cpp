...
_extern _sub_4CE6FD(SobStatic::PatchMarker *const);
...
_extern _sub_4CE72A(WeaponResult *const, WeaponResult const &);
_inline WeaponResult::WeaponResult(WeaponResult const &) // 0x4CE72A
{
    mangled_assert("??0WeaponResult@@QAE@ABV0@@Z");
    compiler_generated();
    todo("implement");
    _sub_4CE72A(this, arg);
}

_extern _sub_4CE759(WeaponResult *const);
...
_extern _sub_4CE76B(ShipStatic::spawnDustCloud *const);
...
_extern _sub_4CE77C(ShipStatic::spawnSalvage *const);
...
_extern void _sub_4CE78D(std::pair<unsigned int,SobStatic::PatchMarker> *const);
...
unsigned __int32 sctSafeGetUdword(unsigned __int32 num, char const *errormsg) // 0x4D0269
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_4D0269(num, errormsg);
    return __result;
}

_extern unsigned __int32 _sub_4D01F5(unsigned __int32, char const *);
unsigned __int32 sctSafeGetSdword(unsigned __int32 num, char const *errormsg) // 0x4D01F5
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_4D01F5(num, errormsg);
    return __result;
}

_extern __int32 _sub_4D3715(lua_State *);
__int32 solLoadHODFile(lua_State *lstate) // 0x4D3715
{
    mangled_assert("?solLoadHODFile@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D3715(lstate);
    return __result;
}

_extern __int32 _sub_4D3897(lua_State *);
__int32 solLoadModel(lua_State *lstate) // 0x4D3897
{
    mangled_assert("?solLoadModel@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D3897(lstate);
    return __result;
}

_extern __int32 _sub_4D3C37(lua_State *);
__int32 solLoadSharedModel(lua_State *lstate) // 0x4D3C37
{
    mangled_assert("?solLoadSharedModel@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D3C37(lstate);
    return __result;
}

_extern void _sub_4CF840(WeaponStatic *, WeaponClassSpecificInfo *, HierarchyStatic *, char const *);
void loadMainGunJoint(WeaponStatic *ws, WeaponClassSpecificInfo *wcsi, HierarchyStatic *hierarchy, char const *shipName) // 0x4CF840
{
    ...
    todo("implement");
    _sub_4CF840(ws, wcsi, hierarchy, shipName);
}

_extern bool _sub_4CF524(GunBinding &, char const *, HierarchyStatic &);
bool loadGunBindingJoint(GunBinding &binding, char const *jointName, HierarchyStatic &hierarchy) // 0x4CF524
{
    ...
    todo("implement");
    bool __result = _sub_4CF524(binding, jointName, hierarchy);
    return __result;
}

_extern void _sub_4CF183(WeaponStaticInfo &, HierarchyStatic &, WeaponClassSpecificInfo *, WeaponStatic *, char const *);
void bindWeapon(WeaponStaticInfo &wsi, HierarchyStatic &hierarcyStatic, WeaponClassSpecificInfo *wcsi, WeaponStatic *ws, char const *shipName) // 0x4CF183
{
    ...
    todo("implement");
    _sub_4CF183(wsi, hierarcyStatic, wcsi, ws, shipName);
}

_extern void _sub_4CF323(WeaponStaticInfo &, HierarchyStatic &, WeaponClassSpecificInfo *, WeaponStatic *, char const *);
void bindWeaponRecoil(WeaponStaticInfo &wsi, HierarchyStatic &hierarcyStatic, WeaponClassSpecificInfo *wcsi, WeaponStatic *ws, char const *shipName) // 0x4CF323
{
    ...
    todo("implement");
    _sub_4CF323(wsi, hierarcyStatic, wcsi, ws, shipName);
}

_extern __int32 _sub_4DBC17(lua_State *);
__int32 solStartShipWeaponConfig(lua_State *lstate) // 0x4DBC17
{
    mangled_assert("?solStartShipWeaponConfig@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4DBC17(lstate);
    return __result;
}

_extern __int32 _sub_4DBF74(lua_State *);
...
void loadHardPointCoordSys(std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &jointName, HierarchyStatic *hierarchy, vector3 &outPosition, matrix3 &outMatrix, char const *shipName) // 0x4CF53F
{
    ...
    todo("implement");
    _sub_4CF53F(jointName, hierarchy, outPosition, outMatrix, shipName);
}

_extern __int32 _sub_4DB8A5(lua_State *);
...
__int32 solSetSpecialTurnLeftManeuver(lua_State *lstate) // 0x4D63C9
{
    ...
    todo("implement");
    __int32 __result = _sub_4D63C9(lstate);
    return __result;
}

_extern __int32 _sub_4D640F(lua_State *);
__int32 solSetSpecialTurnRightManeuver(lua_State *lstate) // 0x4D640F
{
    ...
    todo("implement");
    __int32 __result = _sub_4D640F(lstate);
    return __result;
}

_extern __int32 _sub_4D6383(lua_State *);
__int32 solSetSpecialTurnDownManeuver(lua_State *lstate) // 0x4D6383
{
    ...
    todo("implement");
    __int32 __result = _sub_4D6383(lstate);
    return __result;
}

_extern __int32 _sub_4D6455(lua_State *);
...
__int32 solSetm_pixelColourDepleted(lua_State *lstate) // 0x4D94A2
{
    ...
    todo("implement");
    __int32 __result = _sub_4D94A2(lstate);
    return __result;
}

_extern __int32 _sub_4D9B91(lua_State *);
...
__int32 solSetPebblem_smFadeDistance(lua_State *lstate) // 0x4D5577
{
    ...
    todo("implement");
    __int32 __result = _sub_4D5577(lstate);
    return __result;
}

_extern __int32 _sub_4D55F2(lua_State *);
__int32 solSetPebblem_smFadeMinAlpha(lua_State *lstate) // 0x4D55F2
{
    ...
    todo("implement");
    __int32 __result = _sub_4D55F2(lstate);
    return __result;
}

_extern __int32 _sub_4D566D(lua_State *);
__int32 solSetPebblem_smPixelSize(lua_State *lstate) // 0x4D566D
{
    mangled_assert("?solSetPebblem_smPixelSize@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D566D(lstate);
    return __result;
}

_extern __int32 _sub_4D49F8(lua_State *);
__int32 solSetChargeable(lua_State *lstate) // 0x4D49F8
{
    mangled_assert("?solSetChargeable@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D49F8(lstate);
    return __result;
}

_extern __int32 _sub_4D4EA1(lua_State *);
__int32 solSetDustCloudDamageMultiplier(lua_State *lstate) // 0x4D4EA1
{
    ...
    todo("implement");
    __int32 __result = _sub_4D4EA1(lstate);
    return __result;
}

_extern __int32 _sub_4D501B(lua_State *);
__int32 solSetLightningEffectName(lua_State *lstate) // 0x4D501B
{
    mangled_assert("?solSetLightningEffectName@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D501B(lstate);
    return __result;
}

_extern __int32 _sub_4D4A6C(lua_State *);
...
__int32 solSetm_HealthRegenerateTime(lua_State *lstate) // 0x4D6948
{
    ...
    todo("implement");
    __int32 __result = _sub_4D6948(lstate);
    return __result;
}

_extern __int32 _sub_4D9049(lua_State *);
__int32 solSetm_minHealthRegenerateTime(lua_State *lstate) // 0x4D9049
{
    ...
    todo("implement");
    __int32 __result = _sub_4D9049(lstate);
    return __result;
}

_extern __int32 _sub_4D6E76(lua_State *);
__int32 solSetm_TOScale(lua_State *lstate) // 0x4D6E76
{
    mangled_assert("?solSetm_TOScale@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D6E76(lstate);
    return __result;
}

_extern __int32 _sub_4D6C1E(lua_State *);
__int32 solSetm_TODistanceFade0(lua_State *lstate) // 0x4D6C1E
{
    mangled_assert("?solSetm_TODistanceFade0@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D6C1E(lstate);
    return __result;
}

_extern __int32 _sub_4D6AB6(lua_State *);
__int32 solSetm_TODistanceDisappear0(lua_State *lstate) // 0x4D6AB6
{
    ...
    todo("implement");
    __int32 __result = _sub_4D6AB6(lstate);
    return __result;
}

_extern __int32 _sub_4D6C96(lua_State *);
__int32 solSetm_TODistanceFade1(lua_State *lstate) // 0x4D6C96
{
    mangled_assert("?solSetm_TODistanceFade1@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D6C96(lstate);
    return __result;
}

_extern __int32 _sub_4D6B2E(lua_State *);
__int32 solSetm_TODistanceDisappear1(lua_State *lstate) // 0x4D6B2E
{
    ...
    todo("implement");
    __int32 __result = _sub_4D6B2E(lstate);
    return __result;
}

_extern __int32 _sub_4D6D0E(lua_State *);
__int32 solSetm_TODistanceFade2(lua_State *lstate) // 0x4D6D0E
{
    mangled_assert("?solSetm_TODistanceFade2@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D6D0E(lstate);
    return __result;
}

_extern __int32 _sub_4D6BA6(lua_State *);
...
__int32 solSetm_battleScarMaxTriBase(lua_State *lstate) // 0x4D7689
{
    ...
    todo("implement");
    __int32 __result = _sub_4D7689(lstate);
    return __result;
}

_extern __int32 _sub_4D76FD(lua_State *);
...
__int32 solSetm_avoidanceFamilyIndex(lua_State *lstate) // 0x4D7459
{
    ...
    todo("implement");
    __int32 __result = _sub_4D7459(lstate);
    return __result;
}

_extern __int32 _sub_4D7B2E(lua_State *);
__int32 solSetm_collisionFamilyIndex(lua_State *lstate) // 0x4D7B2E
{
    ...
    todo("implement");
    __int32 __result = _sub_4D7B2E(lstate);
    return __result;
}

_extern __int32 _sub_4D7EC0(lua_State *);
__int32 solSetm_displayFamilyIndex(lua_State *lstate) // 0x4D7EC0
{
    mangled_assert("?solSetm_displayFamilyIndex@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D7EC0(lstate);
    return __result;
}

_extern __int32 _sub_4D738C(lua_State *);
...
__int32 solSetm_chanceOfSpecialDeath(lua_State *lstate) // 0x4D79A1
{
    ...
    todo("implement");
    __int32 __result = _sub_4D79A1(lstate);
    return __result;
}

_extern __int32 _sub_4DAED6(lua_State *);
__int32 solSetm_useTargetRandom(lua_State *lstate) // 0x4DAED6
{
    mangled_assert("?solSetm_useTargetRandom@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4DAED6(lstate);
    return __result;
}

_extern __int32 _sub_4DA283(lua_State *);
__int32 solSetm_targetRandomPointXMin(lua_State *lstate) // 0x4DA283
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA283(lstate);
    return __result;
}

_extern __int32 _sub_4DA208(lua_State *);
__int32 solSetm_targetRandomPointXMax(lua_State *lstate) // 0x4DA208
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA208(lstate);
    return __result;
}

_extern __int32 _sub_4DA379(lua_State *);
__int32 solSetm_targetRandomPointYMin(lua_State *lstate) // 0x4DA379
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA379(lstate);
    return __result;
}

_extern __int32 _sub_4DA2FE(lua_State *);
__int32 solSetm_targetRandomPointYMax(lua_State *lstate) // 0x4DA2FE
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA2FE(lstate);
    return __result;
}

_extern __int32 _sub_4DA46F(lua_State *);
__int32 solSetm_targetRandomPointZMin(lua_State *lstate) // 0x4DA46F
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA46F(lstate);
    return __result;
}

_extern __int32 _sub_4DA3F4(lua_State *);
__int32 solSetm_targetRandomPointZMax(lua_State *lstate) // 0x4DA3F4
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA3F4(lstate);
    return __result;
}

_extern __int32 _sub_4D868D(lua_State *);
__int32 solSetm_formationSwayUpdateTime(lua_State *lstate) // 0x4D868D
{
    ...
    todo("implement");
    __int32 __result = _sub_4D868D(lstate);
    return __result;
}

_extern __int32 _sub_4D84A1(lua_State *);
__int32 solSetm_formationSwayOffsetRandomX(lua_State *lstate) // 0x4D84A1
{
    ...
    todo("implement");
    __int32 __result = _sub_4D84A1(lstate);
    return __result;
}

_extern __int32 _sub_4D851C(lua_State *);
__int32 solSetm_formationSwayOffsetRandomY(lua_State *lstate) // 0x4D851C
{
    ...
    todo("implement");
    __int32 __result = _sub_4D851C(lstate);
    return __result;
}

_extern __int32 _sub_4D8597(lua_State *);
__int32 solSetm_formationSwayOffsetRandomZ(lua_State *lstate) // 0x4D8597
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8597(lstate);
    return __result;
}

_extern __int32 _sub_4D8426(lua_State *);
__int32 solSetm_formationSwayBobbingFactor(lua_State *lstate) // 0x4D8426
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8426(lstate);
    return __result;
}

_extern __int32 _sub_4D8612(lua_State *);
__int32 solSetm_formationSwayRotateFactor(lua_State *lstate) // 0x4D8612
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8612(lstate);
    return __result;
}

_extern __int32 _sub_4D9EF0(lua_State *);
__int32 solSetm_slideMoveRange(lua_State *lstate) // 0x4D9EF0
{
    mangled_assert("?solSetm_slideMoveRange@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D9EF0(lstate);
    return __result;
}

_extern __int32 _sub_4D82C6(lua_State *);
__int32 solSetm_dontDockWithOtherRaceShips(lua_State *lstate) // 0x4D82C6
{
    ...
    todo("implement");
    __int32 __result = _sub_4D82C6(lstate);
    return __result;
}

_extern __int32 _sub_4D8868(lua_State *);
__int32 solSetm_ignoreRaceWhenDocking(lua_State *lstate) // 0x4D8868
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8868(lstate);
    return __result;
}

_extern __int32 _sub_4D7526(lua_State *);
__int32 solSetm_bShipHoldActive(lua_State *lstate) // 0x4D7526
{
    mangled_assert("?solSetm_bShipHoldActive@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D7526(lstate);
    return __result;
}

_extern __int32 _sub_4D92A9(lua_State *);
__int32 solSetm_nbRestrictedHardpoints(lua_State *lstate) // 0x4D92A9
{
    ...
    todo("implement");
    __int32 __result = _sub_4D92A9(lstate);
    return __result;
}

_extern __int32 _sub_4DA4EA(lua_State *);
__int32 solSetm_thrusterAccelTime(lua_State *lstate) // 0x4DA4EA
{
    mangled_assert("?solSetm_thrusterAccelTime@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4DA4EA(lstate);
    return __result;
}

_extern __int32 _sub_4D8CB2(lua_State *);
...
__int32 solSetm_tumbleSpecialDynamicX(lua_State *lstate) // 0x4DA937
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA937(lstate);
    return __result;
}

_extern __int32 _sub_4DA9CE(lua_State *);
__int32 solSetm_tumbleSpecialDynamicY(lua_State *lstate) // 0x4DA9CE
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA9CE(lstate);
    return __result;
}

_extern __int32 _sub_4DAA65(lua_State *);
__int32 solSetm_tumbleSpecialDynamicZ(lua_State *lstate) // 0x4DAA65
{
    ...
    todo("implement");
    __int32 __result = _sub_4DAA65(lstate);
    return __result;
}

_extern __int32 _sub_4D8155(lua_State *);
__int32 solSetm_dockQueueSelectionQueueMultiplier(lua_State *lstate) // 0x4D8155
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8155(lstate);
    return __result;
}

_extern __int32 _sub_4D80DA(lua_State *);
...
__int32 solSetNebulaDamageMultiplier(lua_State *lstate) // 0x4D532D
{
    ...
    todo("implement");
    __int32 __result = _sub_4D532D(lstate);
    return __result;
}

_extern __int32 _sub_4D7A1C(lua_State *);
...
__int32 solSetm_dockTimeBetweenTwoFormations(lua_State *lstate) // 0x4D824B
{
    ...
    todo("implement");
    __int32 __result = _sub_4D824B(lstate);
    return __result;
}

_extern __int32 _sub_4D81D0(lua_State *);
__int32 solSetm_dockTimeBeforeStart(lua_State *lstate) // 0x4D81D0
{
    ...
    todo("implement");
    __int32 __result = _sub_4D81D0(lstate);
    return __result;
}

_extern __int32 _sub_4D805A(lua_State *);
__int32 solSetm_dockNrOfShipsInDockFormation(lua_State *lstate) // 0x4D805A
{
    ...
    todo("implement");
    __int32 __result = _sub_4D805A(lstate);
    return __result;
}

_extern __int32 _sub_4D8B41(lua_State *);
__int32 solSetm_launchTimeBetweenTwoFormations(lua_State *lstate) // 0x4D8B41
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8B41(lstate);
    return __result;
}

_extern __int32 _sub_4D8AC6(lua_State *);
__int32 solSetm_launchTimeBeforeStart(lua_State *lstate) // 0x4D8AC6
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8AC6(lstate);
    return __result;
}

_extern __int32 _sub_4D89CB(lua_State *);
...
__int32 solSetm_baseCloakDetectionLevel(lua_State *lstate) // 0x4D760E
{
    ...
    todo("implement");
    __int32 __result = _sub_4D760E(lstate);
    return __result;
}

_extern __int32 _sub_4D9901(lua_State *);
__int32 solSetm_retaliationDistanceFromGoal(lua_State *lstate) // 0x4D9901
{
    ...
    todo("implement");
    __int32 __result = _sub_4D9901(lstate);
    return __result;
}

_extern __int32 _sub_4D759A(lua_State *);
__int32 solSetm_bTransferable(lua_State *lstate) // 0x4D759A
{
    mangled_assert("?solSetm_bTransferable@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D759A(lstate);
    return __result;
}

_extern __int32 _sub_4D88DC(lua_State *);
__int32 solSetm_isMilitary(lua_State *lstate) // 0x4D88DC
{
    mangled_assert("?solSetm_isMilitary@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D88DC(lstate);
    return __result;
}

_extern __int32 _sub_4D8950(lua_State *);
__int32 solSetm_kamikazeCollisionDamageMultiplier(lua_State *lstate) // 0x4D8950
{
    ...
    todo("implement");
    __int32 __result = _sub_4D8950(lstate);
    return __result;
}

_extern __int32 _sub_4D5C96(lua_State *);
__int32 solSetSSSm_collateralDamage(lua_State *lstate) // 0x4D5C96
{
    ...
    todo("implement");
    __int32 __result = _sub_4D5C96(lstate);
    return __result;
}

_extern __int32 _sub_4D5D85(lua_State *);
__int32 solSetSSSm_inactiveTimeAfterDamage(lua_State *lstate) // 0x4D5D85
{
    ...
    todo("implement");
    __int32 __result = _sub_4D5D85(lstate);
    return __result;
}

_extern __int32 _sub_4D5BA7(lua_State *);
...
__int32 solSetm_clusterSeparationDistance(lua_State *lstate) // 0x4D7AB3
{
    ...
    todo("implement");
    __int32 __result = _sub_4D7AB3(lstate);
    return __result;
}

_extern __int32 _sub_4D939D(lua_State *);
...
__int32 solSetm_proximityDetonationDistance(lua_State *lstate) // 0x4D9713
{
    ...
    todo("implement");
    __int32 __result = _sub_4D9713(lstate);
    return __result;
}

_extern __int32 _sub_4D9F6B(lua_State *);
__int32 solSetm_slowdownFactor(lua_State *lstate) // 0x4D9F6B
{
    mangled_assert("?solSetm_slowdownFactor@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D9F6B(lstate);
    return __result;
}

_extern __int32 _sub_4DAAFC(lua_State *);
__int32 solSetm_tumbleSpeed(lua_State *lstate) // 0x4DAAFC
{
    mangled_assert("?solSetm_tumbleSpeed@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4DAAFC(lstate);
    return __result;
}

_extern __int32 _sub_4DA6F7(lua_State *);
__int32 solSetm_trackingSpeedMultiplier(lua_State *lstate) // 0x4DA6F7
{
    ...
    todo("implement");
    __int32 __result = _sub_4DA6F7(lstate);
    return __result;
}

_extern void _sub_4DC88D(lua_State *, MultiplierType &, InfluenceType &, ActivityRelation &, float &, float &, float &, char const *);
void translateMultiplier(lua_State *lstate, MultiplierType &multType, InfluenceType &inflType, ActivityRelation &actRel, float &multHigh, float &multLow, float &sphereRadius, char const *shipName) // 0x4DC88D
{
    ...
    todo("implement");
    _sub_4DC88D(lstate, multType, inflType, actRel, multHigh, multLow, sphereRadius, shipName);
}

_extern void _sub_4DC74E(lua_State *, AbilityType &, InfluenceType &, float &, char const *, bool &);
...
void solAddHyperSpaceViaGateCommand(ShipStatic *staticptr) // 0x4D1568
{
    ...
    todo("implement");
    _sub_4D1568(staticptr);
}

_extern void _sub_4D12CE(ShipStatic *);
...
void solAbilityCheck(ShipStatic *staticptr, unsigned __int32 ability, char *name) // 0x4D0411
{
    ...
    todo("implement");
    _sub_4D0411(staticptr, ability, name);
}

_extern __int32 _sub_4D042D(lua_State *);
__int32 solAddAbility(lua_State *lstate) // 0x4D042D
{
    mangled_assert("?solAddAbility@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D042D(lstate);
    return __result;
}

_extern void _sub_4D4065(std::vector<WeaponResult,std::allocator<WeaponResult> > const &);
...
_extern bool _sub_4D3F95(WeaponStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadWeapon(WeaponStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D3F95
{
    ...
    todo("implement");
    bool __result = _sub_4D3F95(newStatic, name);
    return __result;
}

_extern bool _sub_4D3CC8(ShipStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadShip(ShipStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D3CC8
{
    ...
    todo("implement");
    bool __result = _sub_4D3CC8(newStatic, name);
    return __result;
}

_extern bool _sub_4D375A(MissileStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadMissile(MissileStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D375A
{
    ...
    todo("implement");
    bool __result = _sub_4D375A(newStatic, name);
    return __result;
}

_extern bool _sub_4D3AC2(ResourceStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &, SobType);
bool solLoadResource(ResourceStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name, SobType type) // 0x4D3AC2
{
    ...
    todo("implement");
    bool __result = _sub_4D3AC2(newStatic, name, type);
    return __result;
}

_extern bool _sub_4D35B3(AsteroidStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadAsteroid(AsteroidStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D35B3
{
    ...
    todo("implement");
    bool __result = _sub_4D35B3(newStatic, name);
    return __result;
}

_extern bool _sub_4D3C1F(SalvageStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadSalvage(SalvageStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D3C1F
{
    ...
    todo("implement");
    bool __result = _sub_4D3C1F(newStatic, name);
    return __result;
}

_extern bool _sub_4D3670(DustCloudStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadDustCloud(DustCloudStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D3670
{
    ...
    todo("implement");
    bool __result = _sub_4D3670(newStatic, name);
    return __result;
}

_extern bool _sub_4D35CB(CloudStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadCloud(CloudStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D35CB
{
    ...
    todo("implement");
    bool __result = _sub_4D35CB(newStatic, name);
    return __result;
}

_extern bool _sub_4D3A1D(PebbleStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
bool solLoadPebble(PebbleStatic *newStatic, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &name) // 0x4D3A1D
{
    ...
    todo("implement");
    bool __result = _sub_4D3A1D(newStatic, name);
    return __result;
}

_extern bool _sub_4D38DC(NebulaStatic *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
...
__int32 solSetAlternativeHyperspaceEffectV(lua_State *lstate) // 0x4D44F1
{
    ...
    todo("implement");
    __int32 __result = _sub_4D44F1(lstate);
    return __result;
}

_extern __int32 _sub_4D43BD(lua_State *);
__int32 solSetAlternativeHyperspaceEffectA(lua_State *lstate) // 0x4D43BD
{
    ...
    todo("implement");
    __int32 __result = _sub_4D43BD(lstate);
    return __result;
}

_extern __int32 _sub_4D4476(lua_State *);
__int32 solSetAlternativeHyperspaceEffectTime(lua_State *lstate) // 0x4D4476
{
    ...
    todo("implement");
    __int32 __result = _sub_4D4476(lstate);
    return __result;
}

_extern __int32 _sub_4D0805(lua_State *);
__int32 solAddAnimTurretSound(lua_State *state) // 0x4D0805
{
    mangled_assert("?solAddAnimTurretSound@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_4D0805(state);
    return __result;
}

_extern void _sub_4D2295();
