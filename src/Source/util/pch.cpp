...
extern std::locale::id std::num_put<char,std::back_insert_iterator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::id; // 0x10007240
extern std::locale::id std::num_put<wchar_t,std::back_insert_iterator<std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t> > > >::id; // 0x10007244
extern std::_Generic_error_category std::_Error_objects<int>::_Generic_object; // 0x10007148
extern std::_Iostream_error_category std::_Error_objects<int>::_Iostream_object; // 0x1000714C
extern std::_System_error_category std::_Error_objects<int>::_System_object; // 0x10007150
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhlfixvUfgroUivovzhvUlyqUkxsOlyq@3E540049E9B80425; // 0x10007238

/* ---------- private variables */

_static
{
    extern std::_Ignore ignore; // 0x1000723D
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x1000723C
    extern std::piecewise_construct_t piecewise_construct; // 0x1000723F
    extern std::allocator_arg_t allocator_arg; // 0x1000723E
}
