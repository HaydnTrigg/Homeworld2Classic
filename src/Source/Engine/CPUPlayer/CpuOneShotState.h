...
_extern _sub_53FFAB(OneShotState *const, CpuSquadGroup &);
_inline OneShotState::OneShotState(CpuSquadGroup &) // 0x53FFAB
{
    mangled_assert("??0OneShotState@@QAE@AAVCpuSquadGroup@@@Z");
    todo("implement");
    _sub_53FFAB(this, arg);
}

_extern void _sub_540089(OneShotState *const);
