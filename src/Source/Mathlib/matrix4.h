...
_extern float &_sub_1000D9B8(matrix4 *const, __int32);
_inline float &matrix4::operator[](__int32) // 0x1000D9B8
{
    mangled_assert("??Amatrix4@@QAEAAMH@Z");
    todo("implement");
    float & __result = _sub_1000D9B8(this, arg);
    return __result;
}

_extern float _sub_10015D1E(matrix4 const *const, __int32);
_inline float matrix4::operator[](__int32) const // 0x10015D1E
{
    mangled_assert("??Amatrix4@@QBEMH@Z");
    todo("implement");
    float __result = _sub_10015D1E(this, arg);
    return __result;
}

_extern _sub_1000D98C(matrix4 *const);
...
_extern _sub_10015C76(matrix4 *const, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float);
_inline matrix4::matrix4(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float) // 0x10015C76
{
    ...
    todo("implement");
    _sub_10015C76(this, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg);
}

_extern matrix4 _sub_1000D9EC(matrix4 const *const, matrix4 const &);
_inline matrix4 matrix4::operator*(matrix4 const &) const // 0x1000D9EC
{
    mangled_assert("??Dmatrix4@@QBE?AV0@ABV0@@Z");
    todo("implement");
    matrix4 __result = _sub_1000D9EC(this, arg);
    return __result;
}

_extern void _sub_1000DC3C(matrix4 *const);
...
_extern float &_sub_65D2A4(matrix4 *const, __int32);
_inline float &matrix4::operator[](__int32) // 0x65D2A4
{
    mangled_assert("??Amatrix4@@QAEAAMH@Z");
    todo("implement");
    float & __result = _sub_65D2A4(this, arg);
    return __result;
}

_extern float _sub_65D2AE(matrix4 const *const, __int32);
_inline float matrix4::operator[](__int32) const // 0x65D2AE
{
    mangled_assert("??Amatrix4@@QBEMH@Z");
    todo("implement");
    float __result = _sub_65D2AE(this, arg);
    return __result;
}

_extern _sub_43F9F9(matrix4 *const);
...
_extern _sub_65D1FC(matrix4 *const, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float);
_inline matrix4::matrix4(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float) // 0x65D1FC
{
    mangled_assert("??0matrix4@@QAE@MMMMMMMMMMMMMMMM@Z");
    todo("implement");
    _sub_65D1FC(this, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg, arg);
}

_extern _sub_43F99D(matrix4 *const, matrix3 const &);
_inline matrix4::matrix4(matrix3 const &) // 0x43F99D
{
    mangled_assert("??0matrix4@@QAE@ABVmatrix3@@@Z");
    todo("implement");
    _sub_43F99D(this, arg);
}

_extern _sub_492CEC(matrix4 *const, matrix3 const &, vector3 const &);
_inline matrix4::matrix4(matrix3 const &, vector3 const &) // 0x492CEC
{
    mangled_assert("??0matrix4@@QAE@ABVmatrix3@@ABVvector3@@@Z");
    todo("implement");
    _sub_492CEC(this, arg, arg);
}

_extern _sub_4E1D15(matrix4 *const, matrix3 const &, vector3 const &, vector3 const &);
_inline matrix4::matrix4(matrix3 const &, vector3 const &, vector3 const &) // 0x4E1D15
{
    ...
    todo("implement");
    _sub_4E1D15(this, arg, arg, arg);
}

_extern matrix3 _sub_4BE2D7(matrix4 const *const);
_inline matrix3 matrix4::operator matrix3() const // 0x4BE2D7
{
    mangled_assert("??Bmatrix4@@QBE?AVmatrix3@@XZ");
    todo("implement");
    matrix3 __result = _sub_4BE2D7(this);
    return __result;
}

_extern void _sub_5D3759(matrix4 &, matrix4 const &, matrix4 const &);
_inline void matrix4FastMultiply(matrix4 &r, matrix4 const &src1, matrix4 const &src2) // 0x5D3759
{
    ...
    todo("implement");
    _sub_5D3759(r, src1, src2);
}

_extern matrix4 _sub_43FE21(matrix4 const *const, matrix4 const &);
_inline matrix4 matrix4::operator*(matrix4 const &) const // 0x43FE21
{
    mangled_assert("??Dmatrix4@@QBE?AV0@ABV0@@Z");
    todo("implement");
    matrix4 __result = _sub_43FE21(this, arg);
    return __result;
}

_extern matrix4 &_sub_48A4D8(matrix4 *const, matrix4 const &);
_inline matrix4 &matrix4::operator*=(matrix4 const &) // 0x48A4D8
{
    mangled_assert("??Xmatrix4@@QAEAAV0@ABV0@@Z");
    todo("implement");
    matrix4 & __result = _sub_48A4D8(this, arg);
    return __result;
}

_extern vector4 _sub_603DF8(matrix4 const *const, vector4 const &);
_inline vector4 matrix4::operator*(vector4 const &) const // 0x603DF8
{
    mangled_assert("??Dmatrix4@@QBE?AVvector4@@ABV1@@Z");
    todo("implement");
    vector4 __result = _sub_603DF8(this, arg);
    return __result;
}

_extern vector4 _sub_44A2D0(vector4 const &, matrix4 const &);
_inline vector4 operator*(vector4 const &v, matrix4 const &m) // 0x44A2D0
{
    mangled_assert("??D@YG?AVvector4@@ABV0@ABVmatrix4@@@Z");
    todo("implement");
    vector4 __result = _sub_44A2D0(v, m);
    return __result;
}

_extern vector4 &_sub_440022(vector4 &, matrix4 const &);
_inline vector4 &operator*=(vector4 &v, matrix4 const &m) // 0x440022
{
    mangled_assert("??X@YGAAVvector4@@AAV0@ABVmatrix4@@@Z");
    todo("implement");
    vector4 & __result = _sub_440022(v, m);
    return __result;
}

_extern vector3 _sub_43FD3F(vector3 const &, matrix4 const &);
_inline vector3 operator*(vector3 const &v, matrix4 const &m) // 0x43FD3F
{
    mangled_assert("??D@YG?AVvector3@@ABV0@ABVmatrix4@@@Z");
    todo("implement");
    vector3 __result = _sub_43FD3F(v, m);
    return __result;
}

_extern void _sub_443857(matrix4 *const);
...
_extern vector4 _sub_4C3E54(matrix4 const *const, __int32);
_inline vector4 matrix4::GetVector4FromRow(__int32) const // 0x4C3E54
{
    ...
    todo("implement");
    vector4 __result = _sub_4C3E54(this, arg);
    return __result;
}

_extern vector3 _sub_4BE41E(matrix4 const *const, __int32);
_inline vector3 matrix4::GetVector3FromRow(__int32) const // 0x4BE41E
{
    ...
    todo("implement");
    vector3 __result = _sub_4BE41E(this, arg);
    return __result;
}

_extern vector3 _sub_666AD7(matrix4 const *const, __int32);
_inline vector3 matrix4::GetVector3FromCol(__int32) const // 0x666AD7
{
    ...
    todo("implement");
    vector3 __result = _sub_666AD7(this, arg);
    return __result;
}
...
_extern float &_sub_10066140(matrix4 *const, __int32);
_inline float &matrix4::operator[](__int32) // 0x10066140
{
    mangled_assert("??Amatrix4@@QAEAAMH@Z");
    todo("implement");
    float & __result = _sub_10066140(this, arg);
    return __result;
}

_extern _sub_1000D820(matrix4 *const);
...
_extern _sub_100951E0(matrix4 *const, matrix3 const &);
_inline matrix4::matrix4(matrix3 const &) // 0x100951E0
{
    mangled_assert("??0matrix4@@QAE@ABVmatrix3@@@Z");
    todo("implement");
    _sub_100951E0(this, arg);
}

_extern matrix3 _sub_1005A110(matrix4 const *const);
_inline matrix3 matrix4::operator matrix3() const // 0x1005A110
{
    mangled_assert("??Bmatrix4@@QBE?AVmatrix3@@XZ");
    todo("implement");
    matrix3 __result = _sub_1005A110(this);
    return __result;
}

_extern matrix4 _sub_10095380(matrix4 const *const, matrix4 const &);
_inline matrix4 matrix4::operator*(matrix4 const &) const // 0x10095380
{
    mangled_assert("??Dmatrix4@@QBE?AV0@ABV0@@Z");
    todo("implement");
    matrix4 __result = _sub_10095380(this, arg);
    return __result;
}

_extern vector4 _sub_1003ED20(vector4 const &, matrix4 const &);
_inline vector4 operator*(vector4 const &v, matrix4 const &m) // 0x1003ED20
{
    mangled_assert("??D@YG?AVvector4@@ABV0@ABVmatrix4@@@Z");
    todo("implement");
    vector4 __result = _sub_1003ED20(v, m);
    return __result;
}

_extern vector4 &_sub_10027B90(vector4 &, matrix4 const &);
_inline vector4 &operator*=(vector4 &v, matrix4 const &m) // 0x10027B90
{
    mangled_assert("??X@YGAAVvector4@@AAV0@ABVmatrix4@@@Z");
    todo("implement");
    vector4 & __result = _sub_10027B90(v, m);
    return __result;
}

_extern vector3 _sub_10027A90(vector3 const &, matrix4 const &);
_inline vector3 operator*(vector3 const &v, matrix4 const &m) // 0x10027A90
{
    mangled_assert("??D@YG?AVvector3@@ABV0@ABVmatrix4@@@Z");
    todo("implement");
    vector3 __result = _sub_10027A90(v, m);
    return __result;
}

_extern void _sub_10019580(matrix4 *const);
