...
extern std::locale::id std::num_put<char,std::back_insert_iterator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::id; // 0x100092E8
extern std::locale::id std::num_put<wchar_t,std::back_insert_iterator<std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t> > > >::id; // 0x100092EC
extern std::_Generic_error_category std::_Error_objects<int>::_Generic_object; // 0x10009000
extern std::_Iostream_error_category std::_Error_objects<int>::_Iostream_object; // 0x10009004
extern std::_System_error_category std::_Error_objects<int>::_System_object; // 0x10009008
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhlfixvUhgvznolyybUivovzhvUlyqUkxsOlyq@2F4BC181F0A6097F; // 0x100092E0

/* ---------- private variables */

_static
{
    extern std::_Ignore ignore; // 0x100092E5
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x100092E4
    extern std::piecewise_construct_t piecewise_construct; // 0x100092E7
    extern std::allocator_arg_t allocator_arg; // 0x100092E6
}
