...
_extern _sub_4AC3BC(ShipHoldStatic *const);
...
_extern void _sub_4AC43B(std::_List_buy<Ship *,std::allocator<Ship *> > *const);
...
_extern void _sub_4AC444(std::_List_buy<Squadron *,std::allocator<Squadron *> > *const);
...
_extern void _sub_4AC49B(std::_Tree_buy<unsigned int,std::allocator<unsigned int> > *const);
...
_extern void _sub_4AC4A4(std::_Tree_buy<std::pair<unsigned int const ,float>,std::allocator<std::pair<unsigned int const ,float> > > *const);
...
_extern void _sub_4AC4AD(std::_Tree_comp<0,std::_Tmap_traits<unsigned int,float,std::less<unsigned int>,std::allocator<std::pair<unsigned int const ,float> >,0> > *const);
...
_extern void _sub_4AC4B6(std::_Tree_comp<0,std::_Tset_traits<unsigned int,std::less<unsigned int>,std::allocator<unsigned int>,0> > *const);
...
_extern void _sub_4AC4E3(std::map<unsigned int,float,std::less<unsigned int>,std::allocator<std::pair<unsigned int const ,float> > > *const);
...
_extern void _sub_4AC4F1(std::set<unsigned int,std::less<unsigned int>,std::allocator<unsigned int> > *const);
...
_extern void _sub_4AC505(GameEvent_ShipDocked *const);
...
_extern void _sub_4AC705(ShipHoldStatic *const);
...
_extern float _sub_4AE6CA(ShipHoldStatic const *const, unsigned __int32);
float ShipHoldStatic::getRepairRateFor(unsigned __int32) const // 0x4AE6CA
{
    ...
    todo("implement");
    float __result = _sub_4AE6CA(this, arg);
    return __result;
}

_extern _sub_4AC19F(ShipHold *const, Ship *, unsigned __int32);
ShipHold::ShipHold(Ship *, unsigned __int32) // 0x4AC19F
{
    mangled_assert("??0ShipHold@@QAE@PAVShip@@I@Z");
    todo("implement");
    _sub_4AC19F(this, arg, arg);
}

_extern _sub_4AC0AF(ShipHold::Data *const);
...
_extern void _sub_4AC50C(ShipHold *const);
...
_extern void _sub_4AD725(ShipHold *const, Squadron *);
void ShipHold::addToHold(Squadron *) // 0x4AD725
{
    mangled_assert("?addToHold@ShipHold@@QAEXPAVSquadron@@@Z");
    todo("implement");
    _sub_4AD725(this, arg);
}

_extern void _sub_4AF787(ShipHold *const);
...
_extern DockPath *_sub_4AE46A(ShipHold const *const, unsigned __int32);
DockPath *ShipHold::getDockLaunchPath(unsigned __int32) const // 0x4AE46A
{
    ...
    todo("implement");
    DockPath * __result = _sub_4AE46A(this, arg);
    return __result;
}

_extern unsigned __int32 _sub_4AE4D8(ShipHold const *const, Sob const *, bool);
unsigned __int32 ShipHold::getNumPathsFor(Sob const *, bool) const // 0x4AE4D8
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_4AE4D8(this, arg, arg);
    return __result;
}

_extern ShipHoldStatic const *_sub_4AE6FF(ShipHold const *const);
...
Squadron *ShipHold::createSquadron(char const *, unsigned __int32) // 0x4ADBC6
{
    ...
    todo("implement");
    Squadron * __result = _sub_4ADBC6(this, arg, arg);
    return __result;
}

_extern void _sub_4AF166(ShipHold *const, Squadron *, bool);
void ShipHold::instantlyAndDestructivelyDockSquadron(Squadron *, bool) // 0x4AF166
{
    ...
    todo("implement");
    _sub_4AF166(this, arg, arg);
}

_extern DockPathStatic *_sub_4AE625(ShipHold const *const, Squadron *, PathType, bool);
DockPathStatic *ShipHold::getPathFor(Squadron *, PathType, bool) const // 0x4AE625
{
    ...
    todo("implement");
    DockPathStatic * __result = _sub_4AE625(this, arg, arg, arg);
    return __result;
}

_extern void _sub_4AE438(ShipHold *const, Squadron *, unsigned __int32, bool);
void ShipHold::forceDock(Squadron *, unsigned __int32, bool) // 0x4AE438
{
    mangled_assert("?forceDock@ShipHold@@AAEXPAVSquadron@@I_N@Z");
    todo("implement");
    _sub_4AE438(this, arg, arg, arg);
}

_extern void _sub_4AF127(ShipHold *const, Squadron *);
void ShipHold::hyperspaceInSquadron(Squadron *) // 0x4AF127
{
    mangled_assert("?hyperspaceInSquadron@ShipHold@@AAEXPAVSquadron@@@Z");
    todo("implement");
    _sub_4AF127(this, arg);
}

_extern void _sub_4AF851(ShipHold *const, Squadron *);
void ShipHold::removeLaunchingSquadronFromHold(Squadron *) // 0x4AF851
{
    ...
    todo("implement");
    _sub_4AF851(this, arg);
}

_extern unsigned __int32 _sub_4AE53F(ShipHold const *const);
unsigned __int32 ShipHold::getNumberOfSleepingShipsHeld() const // 0x4AE53F
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_4AE53F(this);
    return __result;
}

_extern bool _sub_4AD9B7(ShipHold const *const);
bool ShipHold::canHoldShipsInside() const // 0x4AD9B7
{
    mangled_assert("?canHoldShipsInside@ShipHold@@QBE_NXZ");
    todo("implement");
    bool __result = _sub_4AD9B7(this);
    return __result;
}

_extern void _sub_4AFD08(IFFChunk *, __int32);
void skipData(IFFChunk *chunk, __int32 size) // 0x4AFD08
{
    mangled_assert("?skipData@@YGXPAVIFFChunk@@H@Z");
    todo("implement");
    _sub_4AFD08(chunk, size);
}

_extern __int32 _sub_4AE712(IFF *, IFFChunk *, void *, void *);
__int32 ShipHoldStatic::handle_DockingChunk(IFF *iff, IFFChunk *chunk, void *user0, void *user1) // 0x4AE712
{
    ...
    todo("implement");
    __int32 __result = _sub_4AE712(iff, chunk, user0, user1);
    return __result;
}

_extern void _sub_4ADB89(ShipHoldStatic *const, ShipHoldStatic *);
void ShipHoldStatic::copyDockingChunk(ShipHoldStatic *) // 0x4ADB89
{
    mangled_assert("?copyDockingChunk@ShipHoldStatic@@QAEXPAV1@@Z");
    todo("implement");
    _sub_4ADB89(this, arg);
}

_extern bool _sub_4ACA9E(ShipHold *const);
bool ShipHold::UIChangedSinceLastView() // 0x4ACA9E
{
    mangled_assert("?UIChangedSinceLastView@ShipHold@@QAE_NXZ");
    todo("implement");
    bool __result = _sub_4ACA9E(this);
    return __result;
}

_extern void _sub_4ACA96(ShipHold *const);
...
_extern bool _sub_4AFC61(ShipHold const *const);
bool ShipHold::shipHoldCanAcceptNewDockLaunchRequests() const // 0x4AFC61
{
    ...
    todo("implement");
    bool __result = _sub_4AFC61(this);
    return __result;
}

_extern bool _sub_4AFC87(ShipHold const *const);
