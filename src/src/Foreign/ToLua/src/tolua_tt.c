...
_extern char const *_sub_6FB971(lua_State *, __int32);
char const *toluaI_tt_getobjtype(lua_State *L, __int32 lo) // 0x6FB971
{
    mangled_assert("_toluaI_tt_getobjtype@8");
    todo("implement");
    char const * __result = _sub_6FB971(L, lo);
    return __result;
}

_extern __int32 _sub_6FB9AE(lua_State *, char *);
__int32 toluaI_tt_gettag(lua_State *L, char *type) // 0x6FB9AE
{
    mangled_assert("_toluaI_tt_gettag@8");
    todo("implement");
    __int32 __result = _sub_6FB9AE(L, type);
    return __result;
}

_extern void _sub_6FB9F8(lua_State *);
...
_extern __int32 _sub_6FBAA2(lua_State *, __int32);
__int32 toluaI_tt_isusertype(lua_State *L, __int32 lo) // 0x6FBAA2
{
    mangled_assert("_toluaI_tt_isusertype@8");
    todo("implement");
    __int32 __result = _sub_6FBAA2(L, lo);
    return __result;
}

_extern __int32 _sub_6FBD12(lua_State *, __int32, __int32, __int32);
__int32 tolua_istype(lua_State *L, __int32 narg, __int32 tag, __int32 def) // 0x6FBD12
{
    mangled_assert("_tolua_istype@16");
    todo("implement");
    __int32 __result = _sub_6FBD12(L, narg, tag, def);
    return __result;
}

_extern __int32 _sub_6FBC04(lua_State *, __int32, __int32, __int32, __int32);
__int32 tolua_arrayistype(lua_State *L, __int32 narg, __int32 tag, __int32 dim, __int32 def) // 0x6FBC04
{
    ...
    todo("implement");
    __int32 __result = _sub_6FBC04(L, narg, tag, dim, def);
    return __result;
}

_extern __int32 _sub_6FBCC4(lua_State *, __int32);
__int32 tolua_isnoobj(lua_State *L, __int32 narg) // 0x6FBCC4
{
    mangled_assert("_tolua_isnoobj@8");
    todo("implement");
    __int32 __result = _sub_6FBCC4(L, narg);
    return __result;
}

/* ---------- private code */

_extern char const *_sub_6FB736(lua_State *, __int32);
_static char const *gettype(lua_State *L, __int32 tag) // 0x6FB736
{
    mangled_assert("gettype");
    todo("implement");
    char const * __result = _sub_6FB736(L, tag);
    return __result;
}

_extern __int32 _sub_6FB6E6(lua_State *, __int32, __int32);
_static __int32 basetag(lua_State *L, __int32 hierarchy, __int32 tag) // 0x6FB6E6
{
    mangled_assert("basetag");
    todo("implement");
    __int32 __result = _sub_6FB6E6(L, hierarchy, tag);
    return __result;
}

_extern __int32 _sub_6FB78B(lua_State *, __int32, __int32);
_static __int32 istype(lua_State *L, __int32 lo, __int32 tag) // 0x6FB78B
{
    mangled_assert("istype");
    todo("implement");
    __int32 __result = _sub_6FB78B(L, lo, tag);
    return __result;
}
#endif
