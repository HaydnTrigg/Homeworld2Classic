...
extern void jpeg_idct_float(jpeg_decompress_struct *cinfo, jpeg_component_info *compptr, short *coef_block, unsigned char **output_buf, unsigned __int32 output_col);
...
_extern void _sub_100D9460(jpeg_decompress_struct *, jpeg_component_info *, short *, unsigned char **, unsigned __int32);
void jpeg_idct_float(jpeg_decompress_struct *cinfo, jpeg_component_info *compptr, short *coef_block, unsigned char **output_buf, unsigned __int32 output_col) // 0x100D9460
{
    mangled_assert("_jpeg_idct_float@20");
    todo("implement");
    _sub_100D9460(cinfo, compptr, coef_block, output_buf, output_col);
}
