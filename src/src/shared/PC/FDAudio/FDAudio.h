#if 0
#ifndef __FDAUDIO_H__
#define __FDAUDIO_H__
#pragma once
...
{
public:
    FDAudioDevice(FDAudioDevice const &); /* compiler_generated() */
    FDAudioDevice();
...
private:
    ...
    long m_hDriver; // 0x4
    FDAudioDevice::Provider *m_providers; // 0x8
...
public:
    FDAudioDevice &operator=(FDAudioDevice const &); /* compiler_generated() */
};
static_assert(sizeof(FDAudioDevice) == 72, "Invalid FDAudioDevice size");
