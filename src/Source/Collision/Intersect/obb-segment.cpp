...
_extern bool _sub_662B2C(Collision::OBB const &, Collision::Segment const &);
bool Collision::Intersect(Collision::OBB const &obb, Collision::Segment const &segment) // 0x662B2C
{
    ...
    todo("implement");
    bool __result = _sub_662B2C(obb, segment);
    return __result;
}

_extern bool _sub_6628F0(Collision::Segment const &, Collision::OBB const &, __int32 &, vector3 *);
bool Collision::FindIntersection(Collision::Segment const &segment, Collision::OBB const &obb, __int32 &nbIntersection, vector3 *points) // 0x6628F0
{
    ...
    todo("implement");
    bool __result = _sub_6628F0(segment, obb, nbIntersection, points);
    return __result;
}

_extern bool _sub_6625DC(Collision::Segment const &, Collision::OBB const &, float &);
bool Collision::FindFirstIntersectionDistance(Collision::Segment const &segment, Collision::OBB const &obb, float &distance) // 0x6625DC
{
    ...
    todo("implement");
    bool __result = _sub_6625DC(segment, obb, distance);
    return __result;
}
