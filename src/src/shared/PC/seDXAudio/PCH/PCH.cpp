...
#include <pshpack4.h>
#include <winerror.h>
#include "\HICKORY-PCSHIP\Homeworld2Classic\src\src\Shared\PC\seDXAudio\PCH\PCH.h"
...
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhlfixvUhvwczfwrlUivovzhvUlyqUkxsOlyq@B7B18CF3F8867A43; // 0x100072C4

/* ---------- private variables */

_static
{
    extern std::piecewise_construct_t piecewise_construct; // 0x100072CB
    extern std::_Ignore ignore; // 0x100072C9
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x100072C8
    extern std::allocator_arg_t allocator_arg; // 0x100072CA
}
