...
def verify_hash(path_str: str, expected: str):
...
verify_hash("compiler/bin/cl.exe", "09239AA81FB405736393B5BB9519D73173B43A6A")
verify_hash("compiler/bin/mspdb110.dll", "3C0C109BDA6212CAA4C3241DE98C4F8437B7AFAD")
