...
_extern bool _sub_10003B55(bool);
bool dbwShowMouse(bool state) // 0x10003B55
{
    mangled_assert("?dbwShowMouse@@YG_N_N@Z");
    todo("implement");
    bool __result = _sub_10003B55(state);
    return __result;
}

_extern DebugPane *_sub_10003AD2(HWND__ *);
DebugPane *dbwPaneFind(HWND__ *hWnd) // 0x10003AD2
{
    mangled_assert("?dbwPaneFind@@YGPAVDebugPane@@PAUHWND__@@@Z");
    todo("implement");
    DebugPane * __result = _sub_10003AD2(hWnd);
    return __result;
}

_extern long _sub_10003DBD(HWND__ *, unsigned __int32, unsigned __int32, long);
long dbwWindowProc(HWND__ *hWnd, unsigned __int32 message, unsigned __int32 wParam, long lParam) // 0x10003DBD
{
    ...
    todo("implement");
    long __result = _sub_10003DBD(hWnd, message, wParam, lParam);
    return __result;
}

_extern bool _sub_100036E4(char *, char *, char *, char *, char *, __int32);
bool dbwFindString(char *fileName, char *section, char *keyStringIn, char *defaultString, char *returnString, __int32 length) // 0x100036E4
{
    ...
    todo("implement");
    bool __result = _sub_100036E4(fileName, section, keyStringIn, defaultString, returnString, length);
    return __result;
}

_extern __int32 _sub_100034CB(char);
__int32 dbgDataNybble(char c) // 0x100034CB
{
    mangled_assert("?dbgDataNybble@@YGHD@Z");
    todo("implement");
    __int32 __result = _sub_100034CB(c);
    return __result;
}

_extern bool _sub_100035BB(char *, char *, char *, unsigned char *, unsigned __int32);
bool dbwFindBinary(char *fileName, char *section, char *keyStringIn, unsigned char *buffer, unsigned __int32 length) // 0x100035BB
{
    ...
    todo("implement");
    bool __result = _sub_100035BB(fileName, section, keyStringIn, buffer, length);
    return __result;
}

_extern char *_sub_10003AB0(__int32);
char *dbwNumberToName(__int32 index) // 0x10003AB0
{
    mangled_assert("?dbwNumberToName@@YGPADH@Z");
    todo("implement");
    char * __result = _sub_10003AB0(index);
    return __result;
}

_extern bool _sub_10003BB3(unsigned __int32, unsigned __int32);
bool dbwStartup(unsigned __int32 hInstance, unsigned __int32 hWndParent) // 0x10003BB3
{
    mangled_assert("?dbwStartup@@YG_NII@Z");
    todo("implement");
    bool __result = _sub_10003BB3(hInstance, hWndParent);
    return __result;
}

_extern void _sub_10003D3F();
...
_extern __int32 _sub_10003B1B(char const *, char const *);
__int32 dbwPrint(char const *key, char const *string) // 0x10003B1B
{
    mangled_assert("?dbwPrint@@YGHPBD0@Z");
    todo("implement");
    __int32 __result = _sub_10003B1B(key, string);
    return __result;
}

_extern __int32 _sub_10003844(HWND__ *, unsigned __int32, unsigned __int32, long);
__int32 dbwLogOptionsDialogProc(HWND__ *hDialog, unsigned __int32 uMsg, unsigned __int32 wParam, long lParam) // 0x10003844
{
    ...
    todo("implement");
    __int32 __result = _sub_10003844(hDialog, uMsg, wParam, lParam);
    return __result;
}

_extern __int32 _sub_10003556(HWND__ *, unsigned __int32, unsigned __int32, long);
__int32 dbwFilterDialogProc(HWND__ *hDialog, unsigned __int32 uMsg, unsigned __int32 wParam, long lParam) // 0x10003556
{
    ...
    todo("implement");
    __int32 __result = _sub_10003556(hDialog, uMsg, wParam, lParam);
    return __result;
}

_extern bool _sub_10003528(unsigned __int32);
bool dbwConsoleActivate(unsigned __int32 key) // 0x10003528
{
    mangled_assert("?dbwConsoleActivate@@YG_NI@Z");
    todo("implement");
    bool __result = _sub_10003528(key);
    return __result;
}

_extern _sub_10001829(DebugPane *const, __int32, DebugPane *);
DebugPane::DebugPane(__int32, DebugPane *) // 0x10001829
{
    mangled_assert("??0DebugPane@@QAE@HPAV0@@Z");
    todo("implement");
    _sub_10001829(this, arg, arg);
}

_extern void _sub_10001E28(std::_Tree_buy<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > *const);
...
_extern void _sub_10001E31(std::_Tree_comp<0,std::_Tset_traits<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basicstring_less_insensitive<char>,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > >,0> > *const);
...
_extern void _sub_10001E5B(std::set<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basicstring_less_insensitive<char>,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > *const);
...
_extern void _sub_10001E65(AutoCompleteSys *const);
...
_extern void _sub_10001E6A(DebugPane *const);
...
_extern void _sub_10001EDE(std::_Generic_error_category *const);
...
_extern void _sub_10001EE5(std::_Iostream_error_category *const);
...
_extern void _sub_10001EEC(std::_System_error_category *const);
...
_extern __int32 _sub_10004B43(DebugPane *const);
__int32 DebugPane::lineFeed() // 0x10004B43
{
    mangled_assert("?lineFeed@DebugPane@@QAEHXZ");
    todo("implement");
    __int32 __result = _sub_10004B43(this);
    return __result;
}

_extern void _sub_100056F0(DebugPane *const, char const *, bool);
void DebugPane::textEntryInit(char const *, bool) // 0x100056F0
{
    mangled_assert("?textEntryInit@DebugPane@@QAEXPBD_N@Z");
    todo("implement");
    _sub_100056F0(this, arg, arg);
}

_extern void _sub_100047AD(DebugPane *const, char *);
void DebugPane::inputCallback(char *) // 0x100047AD
{
    mangled_assert("?inputCallback@DebugPane@@QAEXPAD@Z");
    todo("implement");
    _sub_100047AD(this, arg);
}

_extern void _sub_10002FA3(DebugPane *const, unsigned __int32, unsigned __int32, unsigned __int32);
void DebugPane::commandProcess(unsigned __int32, unsigned __int32, unsigned __int32) // 0x10002FA3
{
    ...
    todo("implement");
    _sub_10002FA3(this, arg, arg, arg);
}

_extern void _sub_100040F0(DebugPane *const, unsigned __int32);
void DebugPane::editFocus(unsigned __int32) // 0x100040F0
{
    mangled_assert("?editFocus@DebugPane@@QAEXI@Z");
    todo("implement");
    _sub_100040F0(this, arg);
}

_extern void _sub_1000412A(DebugPane *const, char *);
void DebugPane::editFocusKill(char *) // 0x1000412A
{
    mangled_assert("?editFocusKill@DebugPane@@QAEXPAD@Z");
    todo("implement");
    _sub_1000412A(this, arg);
}

_extern void _sub_1000332F(DebugPane *const, _iobuf *, __int32);
...
_extern void _sub_10005592(DebugPane *const);
...
_extern void _sub_100057BA(DebugPane *const, __int32, bool);
void DebugPane::viewScroll(__int32, bool) // 0x100057BA
{
    mangled_assert("?viewScroll@DebugPane@@QAEXH_N@Z");
    todo("implement");
    _sub_100057BA(this, arg, arg);
}

_extern void _sub_100055D9(DebugPane *const);
...
_extern void _sub_10005555(DebugPane *const);
...
_extern bool _sub_100049ED(DebugPane *const, tagRECT *, __int32);
bool DebugPane::limitSize(tagRECT *, __int32) // 0x100049ED
{
    mangled_assert("?limitSize@DebugPane@@QAE_NPAUtagRECT@@H@Z");
    todo("implement");
    bool __result = _sub_100049ED(this, arg, arg);
    return __result;
}

_extern bool _sub_100050C6(DebugPane *const, __int32, __int32);
bool DebugPane::newSize(__int32, __int32) // 0x100050C6
{
    mangled_assert("?newSize@DebugPane@@QAE_NHH@Z");
    todo("implement");
    bool __result = _sub_100050C6(this, arg, arg);
    return __result;
}

_extern bool _sub_10005469(DebugPane *const, __int32, __int32, __int32);
bool DebugPane::resizeBuffer(__int32, __int32, __int32) // 0x10005469
{
    mangled_assert("?resizeBuffer@DebugPane@@QAE_NHHH@Z");
    todo("implement");
    bool __result = _sub_10005469(this, arg, arg, arg);
    return __result;
}

_extern bool _sub_10005819(DebugPane *const, bool);
bool DebugPane::windowSizeToFont(bool) // 0x10005819
{
    mangled_assert("?windowSizeToFont@DebugPane@@QAE_N_N@Z");
    todo("implement");
    bool __result = _sub_10005819(this, arg);
    return __result;
}

_extern bool _sub_100041C8(DebugPane *const, bool);
bool DebugPane::editWindowSizeToFont(bool) // 0x100041C8
{
    mangled_assert("?editWindowSizeToFont@DebugPane@@QAE_N_N@Z");
    todo("implement");
    bool __result = _sub_100041C8(this, arg);
    return __result;
}

_extern void _sub_10004181(DebugPane *const);
...
_extern void _sub_1000469C(DebugPane *const);
...
_extern void _sub_10005436(DebugPane *const);
...
_extern void _sub_10004D48(DebugPane *const);
...
_extern void _sub_10004CA8(DebugPane *const, HWND__ *);
void DebugPane::logDialogInit(HWND__ *) // 0x10004CA8
{
    mangled_assert("?logDialogInit@DebugPane@@QAEXPAUHWND__@@@Z");
    todo("implement");
    _sub_10004CA8(this, arg);
}

_extern void _sub_10004F33(DebugPane *const);
...
_extern void _sub_100021EF(AutoCompleteSys *const, DebugPane *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
void AutoCompleteSys::Complete(DebugPane *, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &) // 0x100021EF
{
    ...
    todo("implement");
    _sub_100021EF(this, arg, arg);
}

_extern void _sub_10002356(AutoCompleteSys *const, char const *);
void AutoCompleteSys::KeywordAdd(char const *) // 0x10002356
{
    mangled_assert("?KeywordAdd@AutoCompleteSys@@QAEXPBD@Z");
    todo("implement");
    _sub_10002356(this, arg);
}

_extern void _sub_1000240D(AutoCompleteSys *const, char const *);
void AutoCompleteSys::KeywordRmv(char const *) // 0x1000240D
{
    mangled_assert("?KeywordRmv@AutoCompleteSys@@QAEXPBD@Z");
    todo("implement");
    _sub_1000240D(this, arg);
}

_extern void _sub_10002452(AutoCompleteSys *const);
...
_extern bool _sub_1000232F(AutoCompleteSys *const, char const *);
bool AutoCompleteSys::Detect(char const *) // 0x1000232F
{
    mangled_assert("?Detect@AutoCompleteSys@@QAE_NPBD@Z");
    todo("implement");
    bool __result = _sub_1000232F(this, arg);
    return __result;
}

_extern void _sub_1000380A(char const *);
void dbwKeywordAdd(char const *luaFuncName) // 0x1000380A
{
    mangled_assert("?dbwKeywordAdd@@YGXPBD@Z");
    todo("implement");
    _sub_1000380A(luaFuncName);
}

_extern void _sub_10003818(char const *);
void dbwKeywordRmv(char const *luaFuncName) // 0x10003818
{
    mangled_assert("?dbwKeywordRmv@@YGXPBD@Z");
    todo("implement");
    _sub_10003818(luaFuncName);
}

/* ---------- private code */

_extern bool _sub_1000239F(std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
_static bool KeywordIsPartialMatch(std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &input, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &keyword) // 0x1000239F
{
    ...
    todo("implement");
    bool __result = _sub_1000239F(input, keyword);
    return __result;
}

_extern std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > _sub_100023D1(std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &, std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &, std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &);
_static std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > KeywordNext(std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &first, std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &end, std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > const &current, std::basic_string<char,std::char_traits<char>,std::allocator<char> > const &input) // 0x100023D1
{
    ...
    todo("implement");
    std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > __result = _sub_100023D1(first, end, current, input);
    return __result;
}
#endif
