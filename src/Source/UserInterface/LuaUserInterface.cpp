...
_extern _sub_679DE1(UI::LuaUserInterfaceLib *const);
...
_extern void _sub_679E22(LuaBinding::ObjInternal0<unsigned int,LuaBinding::Functor0Free<unsigned int> > *const);
...
_extern void _sub_679E28(LuaBinding::ObjInternal1<char const *,bool,LuaBinding::Functor1Free<char const *,bool> > *const);
...
_extern void _sub_679E2E(LuaBinding::ObjInternal2<char const *,char const *,bool,LuaBinding::Functor2Free<char const *,char const *,bool> > *const);
...
_extern void _sub_679E34(LuaBinding::ObjInternal2<char const *,bool,bool,LuaBinding::Functor2Free<char const *,bool,bool> > *const);
...
_extern void _sub_679E3A(LuaBinding::ObjInternal3<char const *,char const *,int,bool,LuaBinding::Functor3Free<char const *,char const *,int,bool> > *const);
...
_extern void _sub_679E40(LuaBinding::ObjInternal3<char const *,char const *,char const *,bool,LuaBinding::Functor3Free<char const *,char const *,char const *,bool> > *const);
...
_extern void _sub_679E6A(UI::LuaUserInterfaceLib *const);
...
_extern void _sub_679E46(LuaBinding::ObjInternal3<char const *,char const *,bool,void,LuaBinding::Functor3Free<char const *,char const *,bool,void> > *const);
...
_extern void _sub_679E4C(LuaBinding::ObjInternal3<char const *,char const *,bool,bool,LuaBinding::Functor3Free<char const *,char const *,bool,bool> > *const);
...
_extern void _sub_679E52(LuaBinding::ObjInternal4<char const *,char const *,int,int,bool,LuaBinding::Functor4Free<char const *,char const *,int,int,bool> > *const);
...
_extern void _sub_679E58(LuaBinding::ObjInternal4<char const *,char const *,char const *,unsigned int,bool,LuaBinding::Functor4Free<char const *,char const *,char const *,unsigned int,bool> > *const);
...
_extern void _sub_679E5E(LuaBinding::ObjInternal5<char const *,char const *,char const *,char const *,int,bool,LuaBinding::Functor5Free<char const *,char const *,char const *,char const *,int,bool> > *const);
...
_extern bool _sub_67A7DB(UI::LuaUserInterfaceLib *const, LuaConfig &);
_inline bool UI::LuaUserInterfaceLib::Register(LuaConfig &) // 0x67A7DB
{
    ...
    todo("implement");
    bool __result = _sub_67A7DB(this, arg);
    return __result;
}

_extern void _sub_679E64(LuaBinding::ObjInternal5<char const *,char const *,char const *,char const *,char const *,void,LuaBinding::Functor5Free<char const *,char const *,char const *,char const *,char const *,void> > *const);
...
_extern bool _sub_67A19D(UI::LuaUserInterfaceLib *const, LuaConfig &);
_inline bool UI::LuaUserInterfaceLib::DeRegister(LuaConfig &) // 0x67A19D
{
    ...
    todo("implement");
    bool __result = _sub_67A19D(this, arg);
    return __result;
}

/* ---------- private code */

_extern UI::InterfaceElement *_sub_67A797(char const *, char const *);
_static UI::InterfaceElement *UI::GetScreenElement(char const *screenName, char const *elementName) // 0x67A797
{
    ...
    todo("implement");
    UI::InterfaceElement * __result = _sub_67A797(screenName, elementName);
    return __result;
}

_extern void _sub_67B2EF(char const *);
...
_extern void _sub_67B415(char const *);
...
_extern bool _sub_67B7F6(char const *, char const *, char const *);
_static bool UI::UI_SetTextLabelText(char const *screenName, char const *elementName, char const *text) // 0x67B7F6
{
    ...
    todo("implement");
    bool __result = _sub_67B7F6(screenName, elementName, text);
    return __result;
}

_extern bool _sub_67B67B(char const *, char const *, char const *, unsigned __int32);
_static bool UI::UI_SetLabelTextHotkey(char const *screenName, char const *elementName, char const *text, unsigned __int32 hkeyID) // 0x67B67B
{
    ...
    todo("implement");
    bool __result = _sub_67B67B(screenName, elementName, text, hkeyID);
    return __result;
}

_extern bool _sub_67B47E(char const *, char const *, char const *, unsigned __int32);
_static bool UI::UI_SetButtonTextHotkey(char const *screenName, char const *elementName, char const *text, unsigned __int32 hkeyID) // 0x67B47E
{
    ...
    todo("implement");
    bool __result = _sub_67B47E(screenName, elementName, text, hkeyID);
    return __result;
}

_extern void _sub_67B292(char const *, char const *);
_static void UI::UI_GiveFocus(char const *elementName, char const *screenName) // 0x67B292
{
    mangled_assert("UI::UI_GiveFocus");
    todo("implement");
    _sub_67B292(elementName, screenName);
}

_extern void _sub_67B958(char const *, __int32);
_static void UI::UI_ToggleScreen(char const *name, __int32 transType) // 0x67B958
{
    mangled_assert("UI::UI_ToggleScreen");
    todo("implement");
    _sub_67B958(name, transType);
}

_extern void _sub_67B995(char const *, char const *, char const *, char const *, char const *);
_static void UI::UI_ToggleScreenElement(char const *screenActive, char const *firstScreenName, char const *firstElementName, char const *secondScreenName, char const *secondElementName) // 0x67B995
{
    ...
    todo("implement");
    _sub_67B995(screenActive, firstScreenName, firstElementName, secondScreenName, secondElementName);
}

_extern void _sub_67B382(char const *);
_static void UI::UI_PlaySound(char const *soundName) // 0x67B382
{
    mangled_assert("UI::UI_PlaySound");
    todo("implement");
    _sub_67B382(soundName);
}

_extern bool _sub_67B879(char const *, char const *, char const *, char const *, __int32);
...
_static bool UI::UI_SetNextScreen(char const *screenName, char const *nextScreenName) // 0x67B71E
{
    ...
    todo("implement");
    bool __result = _sub_67B71E(screenName, nextScreenName);
    return __result;
}

_extern bool _sub_67B758(char const *, char const *);
_static bool UI::UI_SetPreviousScreen(char const *screenName, char const *prevScreenName) // 0x67B758
{
    ...
    todo("implement");
    bool __result = _sub_67B758(screenName, prevScreenName);
    return __result;
}

_extern bool _sub_67B344(__int32);
_static bool UI::UI_NextScreen(__int32 transType) // 0x67B344
{
    mangled_assert("UI::UI_NextScreen");
    todo("implement");
    bool __result = _sub_67B344(transType);
    return __result;
}

_extern bool _sub_67B3A1(__int32);
_static bool UI::UI_PreviousScreen(__int32 transType) // 0x67B3A1
{
    mangled_assert("UI::UI_PreviousScreen");
    todo("implement");
    bool __result = _sub_67B3A1(transType);
    return __result;
}

_extern bool _sub_67B5C7(char const *, char const *, bool);
_static bool UI::UI_SetElementVisible(char const *screenName, char const *elementName, bool visible) // 0x67B5C7
{
    ...
    todo("implement");
    bool __result = _sub_67B5C7(screenName, elementName, visible);
    return __result;
}

_extern bool _sub_67B528(char const *, char const *, bool);
_static bool UI::UI_SetElementEnabled(char const *screenName, char const *elementName, bool enable) // 0x67B528
{
    ...
    todo("implement");
    bool __result = _sub_67B528(screenName, elementName, enable);
    return __result;
}

_extern bool _sub_67B1FA(char const *, char const *, __int32);
_static bool UI::UI_FlashButton(char const *screenName, char const *elementName, __int32 numberOfTimes) // 0x67B1FA
{
    ...
    todo("implement");
    bool __result = _sub_67B1FA(screenName, elementName, numberOfTimes);
    return __result;
}

_extern bool _sub_67B919(char const *, char const *);
_static bool UI::UI_StopFlashButton(char const *screenName, char const *elementName) // 0x67B919
{
    ...
    todo("implement");
    bool __result = _sub_67B919(screenName, elementName);
    return __result;
}

_extern bool _sub_67B782(char const *, bool);
_static bool UI::UI_SetScreenEnabled(char const *screenName, bool enabled) // 0x67B782
{
    mangled_assert("UI::UI_SetScreenEnabled");
    todo("implement");
    bool __result = _sub_67B782(screenName, enabled);
    return __result;
}

_extern bool _sub_67B7AD(char const *, bool);
_static bool UI::UI_SetScreenVisible(char const *screenName, bool visible) // 0x67B7AD
{
    mangled_assert("UI::UI_SetScreenVisible");
    todo("implement");
    bool __result = _sub_67B7AD(screenName, visible);
    return __result;
}

_extern void _sub_67B61B(bool);
...
_extern bool _sub_67B331(char const *);
_static bool UI::UI_IsScreenActive(char const *screenName) // 0x67B331
{
    mangled_assert("UI::UI_IsScreenActive");
    todo("implement");
    bool __result = _sub_67B331(screenName);
    return __result;
}

_extern bool _sub_67B302(char const *, char const *);
_static bool UI::UI_IsNamedElementVisible(char const *screenName, char const *element) // 0x67B302
{
    ...
    todo("implement");
    bool __result = _sub_67B302(screenName, element);
    return __result;
}

_extern bool _sub_67B58A(char const *, char const *, __int32, __int32);
_static bool UI::UI_SetElementSize(char const *screenName, char const *elementName, __int32 w, __int32 h) // 0x67B58A
{
    ...
    todo("implement");
    bool __result = _sub_67B58A(screenName, elementName, w, h);
    return __result;
}

_extern bool _sub_67B54D(char const *, char const *, __int32, __int32);
_static bool UI::UI_SetElementPosition(char const *screenName, char const *elementName, __int32 x, __int32 y) // 0x67B54D
{
    ...
    todo("implement");
    bool __result = _sub_67B54D(screenName, elementName, x, y);
    return __result;
}

_extern bool _sub_67B428(char const *);
_static bool UI::UI_ScreenIsActive(char const *name) // 0x67B428
{
    mangled_assert("UI::UI_ScreenIsActive");
    todo("implement");
    bool __result = _sub_67B428(name);
    return __result;
}

_extern void _sub_67B0D5();
...
_extern void _sub_67B09D(char const *);
_static void UI::UI_AddToEventScreen(char const *speechname) // 0x67B09D
{
    mangled_assert("UI::UI_AddToEventScreen");
    todo("implement");
    _sub_67B09D(speechname);
}

_extern void _sub_67B448(char const *, char const *, bool);
_static void UI::UI_SetButtonPressed(char const *screen, char const *element, bool pressed) // 0x67B448
{
    ...
    todo("implement");
    _sub_67B448(screen, element, pressed);
}
#endif
