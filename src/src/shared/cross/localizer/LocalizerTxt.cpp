...
_extern __int32 _sub_10006B40(LocalizerResourceTxt::Range const &, std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &);
__int32 RangeGetNextId(LocalizerResourceTxt::Range const &range, std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &lines) // 0x10006B40
{
    ...
    todo("implement");
    __int32 __result = _sub_10006B40(range, lines);
    return __result;
}

_extern _sub_10005DA3(LocalizerResourceTxt *const, char const *);
LocalizerResourceTxt::LocalizerResourceTxt(char const *) // 0x10005DA3
{
    mangled_assert("??0LocalizerResourceTxt@@AAE@PBD@Z");
    todo("implement");
    _sub_10005DA3(this, arg);
}

_extern void _sub_10005E2F(std::_Vector_alloc<1,std::_Vec_base_types<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > > *const);
...
_extern void _sub_10005E30(std::_Vector_alloc<1,std::_Vec_base_types<LocalizerResourceTxt::Range,mempool_alloc<LocalizerResourceTxt::Range> > > *const);
...
_extern void _sub_10005E31(std::_Wrap_alloc<mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > *const);
...
_extern void _sub_10005E32(std::_Wrap_alloc<mempool_alloc<LocalizerResourceTxt::Range> > *const);
...
_extern void _sub_10005E4C(LocalizerResourceTxt *const);
...
_extern LocalizerImp::Resource *_sub_100065E5(char const *);
LocalizerImp::Resource *LocalizerResourceTxt::Load(char const *filename) // 0x100065E5
{
    ...
    todo("implement");
    LocalizerImp::Resource * __result = _sub_100065E5(filename);
    return __result;
}

_extern bool _sub_100062F5(LocalizerResourceTxt const *const, wchar_t *, unsigned __int32, __int32);
bool LocalizerResourceTxt::GetString(wchar_t *, unsigned __int32, __int32) const // 0x100062F5
{
    ...
    todo("implement");
    bool __result = _sub_100062F5(this, arg, arg, arg);
    return __result;
}

_extern bool _sub_10006BDD(LocalizerResourceTxt *const, __int32, __int32);
bool LocalizerResourceTxt::ResetRange(__int32, __int32) // 0x10006BDD
{
    mangled_assert("?ResetRange@LocalizerResourceTxt@@QAE_NHH@Z");
    todo("implement");
    bool __result = _sub_10006BDD(this, arg, arg);
    return __result;
}

_extern __int32 _sub_100061AA(LocalizerResourceTxt *const, wchar_t const *, __int32 const, __int32 const, __int32 const);
__int32 LocalizerResourceTxt::AddText(wchar_t const *, __int32 const, __int32 const, __int32 const) // 0x100061AA
{
    ...
    todo("implement");
    __int32 __result = _sub_100061AA(this, arg, arg, arg, arg);
    return __result;
}

_extern bool _sub_10006C53(LocalizerResourceTxt *const, char const *);
bool LocalizerResourceTxt::Save(char const *) // 0x10006C53
{
    mangled_assert("?Save@LocalizerResourceTxt@@QAE_NPBD@Z");
    todo("implement");
    bool __result = _sub_10006C53(this, arg);
    return __result;
}

_extern bool _sub_100060DB(LocalizerResourceTxt *const, __int32 &, __int32 &, unsigned __int32 const, char const *);
bool LocalizerResourceTxt::AddRange(__int32 &, __int32 &, unsigned __int32 const, char const *) // 0x100060DB
{
    ...
    todo("implement");
    bool __result = _sub_100060DB(this, arg, arg, arg, arg);
    return __result;
}

_extern char const *_sub_100062E9(LocalizerResourceTxt const *const);
char const *LocalizerResourceTxt::GetName() const // 0x100062E9
{
    mangled_assert("?GetName@LocalizerResourceTxt@@UBEPBDXZ");
    todo("implement");
    char const * __result = _sub_100062E9(this);
    return __result;
}

_extern __int32 _sub_10006B75(LocalizerResourceTxt const *const);
__int32 LocalizerResourceTxt::RangeMin() const // 0x10006B75
{
    mangled_assert("?RangeMin@LocalizerResourceTxt@@UBEHXZ");
    todo("implement");
    __int32 __result = _sub_10006B75(this);
    return __result;
}

_extern __int32 _sub_10006B71(LocalizerResourceTxt const *const);
__int32 LocalizerResourceTxt::RangeMax() const // 0x10006B71
{
    mangled_assert("?RangeMax@LocalizerResourceTxt@@UBEHXZ");
    todo("implement");
    __int32 __result = _sub_10006B71(this);
    return __result;
}

_extern std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > _sub_100062D1(LocalizerResourceTxt const *const);
std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > LocalizerResourceTxt::Begin() const // 0x100062D1
{
    ...
    todo("implement");
    std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > __result = _sub_100062D1(this);
    return __result;
}

_extern std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > _sub_100062DD(LocalizerResourceTxt const *const);
std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > LocalizerResourceTxt::End() const // 0x100062DD
{
    ...
    todo("implement");
    std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > __result = _sub_100062DD(this);
    return __result;
}

/* ---------- private code */

_extern void _sub_10006EDA(LocalizerResourceTxt::Line &);
...
_extern void _sub_10006F68(LocalizerResourceTxt::Line &, char const *, wchar_t const *, char const *);
_static void TxtLineSetup(LocalizerResourceTxt::Line &line, char const *strAnsi, wchar_t const *strUnicode, char const *comment) // 0x10006F68
{
    ...
    todo("implement");
    _sub_10006F68(line, strAnsi, strUnicode, comment);
}

_extern void _sub_10006F27(LocalizerResourceTxt::Line &, char const *, char const *);
_static void TxtLineSetup(LocalizerResourceTxt::Line &line, char const *strAnsi, char const *comment) // 0x10006F27
{
    mangled_assert("TxtLineSetup");
    todo("implement");
    _sub_10006F27(line, strAnsi, comment);
}

_extern void _sub_10006FEC(LocalizerResourceTxt::Line &, char const *, wchar_t const *);
_static void TxtLineUpdate(LocalizerResourceTxt::Line &line, char const *strAnsi, wchar_t const *strUnicode) // 0x10006FEC
{
    ...
    todo("implement");
    _sub_10006FEC(line, strAnsi, strUnicode);
}

_extern void _sub_10007009(LocalizerResourceTxt::Line &, wchar_t const *);
_static void TxtLineUpdate(LocalizerResourceTxt::Line &line, wchar_t const *strUnicode) // 0x10007009
{
    mangled_assert("TxtLineUpdate");
    todo("implement");
    _sub_10007009(line, strUnicode);
}

_extern std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > _sub_10006E54(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > &, __int32);
_static std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > TxtLineFind(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > &lines, __int32 lineNb) // 0x10006E54
{
    ...
    todo("implement");
    std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > __result = _sub_10006E54(lines, lineNb);
    return __result;
}

_extern std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > _sub_10006E1C(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &, __int32);
_static std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > TxtLineFind(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &lines, __int32 lineNb) // 0x10006E1C
{
    mangled_assert("TxtLineFind");
    todo("implement");
    std::_Vector_const_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > __result = _sub_10006E1C(lines, lineNb);
    return __result;
}

_extern bool _sub_10006DF9(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &, __int32);
_static bool TxtLineDuplicate(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > const &lines, __int32 lineNb) // 0x10006DF9
{
    ...
    todo("implement");
    bool __result = _sub_10006DF9(lines, lineNb);
    return __result;
}

_extern std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > _sub_10006E8C(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > &, __int32, LocalizerResourceTxt::Line);
_static std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > TxtLineInsert(std::vector<std::pair<int,LocalizerResourceTxt::Line>,mempool_alloc<std::pair<int,LocalizerResourceTxt::Line> > > &lines, __int32 lineNb, LocalizerResourceTxt::Line line) // 0x10006E8C
{
    ...
    todo("implement");
    std::_Vector_iterator<std::_Vector_val<std::_Simple_types<std::pair<int,LocalizerResourceTxt::Line> > > > __result = _sub_10006E8C(lines, lineNb, line);
    return __result;
}

_extern bool _sub_10006B06(std::vector<LocalizerResourceTxt::Range,mempool_alloc<LocalizerResourceTxt::Range> > const &, __int32, __int32);
_static bool RangeDuplicate(std::vector<LocalizerResourceTxt::Range,mempool_alloc<LocalizerResourceTxt::Range> > const &ranges, __int32 min, __int32 max) // 0x10006B06
{
    ...
    todo("implement");
    bool __result = _sub_10006B06(ranges, min, max);
    return __result;
}

_extern void _sub_10006B79(LocalizerResourceTxt::Range &);
...
_extern void _sub_10006B9B(LocalizerResourceTxt::Range &, char const *, __int32, __int32);
_static void RangeSetup(LocalizerResourceTxt::Range &range, char const *comment, __int32 min, __int32 max) // 0x10006B9B
{
    ...
    todo("implement");
    _sub_10006B9B(range, comment, min, max);
}

_extern bool _sub_1000633B(char);
_static _inline bool LineIsWSChar(char c) // 0x1000633B
{
    mangled_assert("LineIsWSChar");
    todo("implement");
    bool __result = _sub_1000633B(c);
    return __result;
}

_extern void _sub_100065B9(char *);
