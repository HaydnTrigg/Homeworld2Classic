...
_extern void _sub_5C9902(char const *, char const *, vector3, __int32, vector3, unsigned __int32, bool);
void DtmLoad::addSquadron(char const *squadname, char const *shipname, vector3 location, __int32 owner, vector3 rot, unsigned __int32 squadronSize, bool startinHyperspace) // 0x5C9902
{
    ...
    todo("implement");
    _sub_5C9902(squadname, shipname, location, owner, rot, squadronSize, startinHyperspace);
}

_extern void _sub_5C948B(char const *, vector3, __int32, vector3);
void DtmLoad::addMissile(char const *minename, vector3 location, __int32 owner, vector3 rot) // 0x5C948B
{
    ...
    todo("implement");
    _sub_5C948B(minename, location, owner, rot);
}

_extern void _sub_5C9EBF(char const *);
void DtmLoad::createSOBGroup(char const *sobGroupName) // 0x5C9EBF
{
    mangled_assert("?createSOBGroup@DtmLoad@@YGXPBD@Z");
    todo("implement");
    _sub_5C9EBF(sobGroupName);
}

_extern void _sub_5C9E7F(char const *, char const *);
void DtmLoad::addToSOBGroup(char const *squadronName, char const *sobGroupName) // 0x5C9E7F
{
    ...
    todo("implement");
    _sub_5C9E7F(squadronName, sobGroupName);
}

_extern void _sub_5C9810(char const *, vector3, float, float, float, float);
void DtmLoad::addResourcePatch(char const *patchName, vector3 location, float value, float rotx, float roty, float rotz) // 0x5C9810
{
    ...
    todo("implement");
    _sub_5C9810(patchName, location, value, rotx, roty, rotz);
}

_extern void _sub_5C9063(char const *, vector3, float, float, float, float, __int32);
void DtmLoad::addAsteroid(char const *patchName, vector3 location, float value, float rotx, float roty, float rotz, __int32 canBeToppedUpByReactiveFleet) // 0x5C9063
{
    ...
    todo("implement");
    _sub_5C9063(patchName, location, value, rotx, roty, rotz, canBeToppedUpByReactiveFleet);
}

_extern void _sub_5C981F(char const *, vector3, float, float, float, float, __int32);
void DtmLoad::addSalvage(char const *patchName, vector3 location, float value, float rotx, float roty, float rotz, __int32 canBeToppedUpByReactiveFleet) // 0x5C981F
{
    ...
    todo("implement");
    _sub_5C981F(patchName, location, value, rotx, roty, rotz, canBeToppedUpByReactiveFleet);
}

_extern void _sub_5C9455(char const *, char const *, vector3, vector4, float, float);
void DtmLoad::addDustCloud(char const *dustCloudGroupName, char const *patchName, vector3 location, vector4 color, float rotzDegrees, float radius) // 0x5C9455
{
    ...
    todo("implement");
    _sub_5C9455(dustCloudGroupName, patchName, location, color, rotzDegrees, radius);
}

_extern void _sub_5C9694(char const *, vector3, float, float, float);
void NonDtmLoad::addPebble(char const *patchName, vector3 location, float rotx, float roty, float rotz) // 0x5C9694
{
    ...
    todo("implement");
    _sub_5C9694(patchName, location, rotx, roty, rotz);
}

_extern void _sub_5C9427(char const *, char const *, vector3, vector4, float, float);
void NonDtmLoad::addCloud(char const *dustCloudGroupName, char const *patchName, vector3 location, vector4 color, float rotzDegrees, float radius) // 0x5C9427
{
    ...
    todo("implement");
    _sub_5C9427(dustCloudGroupName, patchName, location, color, rotzDegrees, radius);
}

_extern void _sub_5C97B9(char const *, __int32, __int32, vector3, float, float, float, char const *);
void NonDtmLoad::addReactiveFleetSlot(char const *slotSobGroupName, __int32 playerID, __int32 inHyperspace, vector3 location, float rotx, float roty, float rotz, char const *allowedShipTypes) // 0x5C97B9
{
    ...
    todo("implement");
    _sub_5C97B9(slotSobGroupName, playerID, inHyperspace, location, rotx, roty, rotz, allowedShipTypes);
}

_extern void _sub_5C900D(char const *, vector3);
void NonDtmLoad::addAmbientSound(char const *ambientSound, vector3 location) // 0x5C900D
{
    ...
    todo("implement");
    _sub_5C900D(ambientSound, location);
}

_extern void _sub_5C9773(char const *, vector3, float, float, float);
void NonDtmLoad::addReactiveFleetResourceSlot(char const *name, vector3 location, float rotx, float roty, float rotz) // 0x5C9773
{
    ...
    todo("implement");
    _sub_5C9773(name, location, rotx, roty, rotz);
}

_extern void _sub_5CA108(vector4);
...
_extern void _sub_5CA127(vector4);
...
_extern void _sub_5CA117(vector3);
void NonDtmLoad::setFXWind(vector3 windStrength) // 0x5CA117
{
    mangled_assert("?setFXWind@NonDtmLoad@@YGXVvector3@@@Z");
    todo("implement");
    _sub_5CA117(windStrength);
}

_extern void _sub_5C9523(char const *, char const *, vector3, vector4, float, float);
void DtmLoad::addNebula(char const *nebulaGroupName, char const *patchName, vector3 location, vector4 color, float rotzDegrees, float radius) // 0x5C9523
{
    ...
    todo("implement");
    _sub_5C9523(nebulaGroupName, patchName, location, color, rotzDegrees, radius);
}

_extern void _sub_5C96A5(char const *, vector3, vector3);
void DtmLoad::addPoint(char const *name, vector3 location, vector3 rot) // 0x5C96A5
{
    ...
    todo("implement");
    _sub_5C96A5(name, location, rot);
}

_extern void _sub_5C911F(char const *, vector3, float);
void DtmLoad::addAxisAlignBox(char const *name, vector3 loc, float size) // 0x5C911F
{
    ...
    todo("implement");
    _sub_5C911F(name, loc, size);
}

_extern void _sub_5CA1A0(vector3, vector3);
void NonDtmLoad::setWorldBoundsInner(vector3 centre, vector3 inner) // 0x5CA1A0
{
    ...
    todo("implement");
    _sub_5CA1A0(centre, inner);
}

_extern void _sub_5CA2D4(vector3, vector3);
void NonDtmLoad::setWorldBoundsOuter(vector3 centre, vector3 outer) // 0x5CA2D4
{
    ...
    todo("implement");
    _sub_5CA2D4(centre, outer);
}

_extern void _sub_5C98A7(char const *, vector3, float);
void DtmLoad::addSphere(char const *name, vector3 location, float radius) // 0x5C98A7
{
    ...
    todo("implement");
    _sub_5C98A7(name, location, radius);
}

_extern __int32 _sub_5C9554(lua_State *);
__int32 DtmLoad::addPath(lua_State *lstate) // 0x5C9554
{
    mangled_assert("?addPath@DtmLoad@@YGHPAUlua_State@@@Z");
    todo("implement");
    __int32 __result = _sub_5C9554(lstate);
    return __result;
}

_extern void _sub_5C91D8(char const *, vector3, vector3);
void DtmLoad::addCamera(char const *name, vector3 targetposition, vector3 eyePosition) // 0x5C91D8
{
    ...
    todo("implement");
    _sub_5C91D8(name, targetposition, eyePosition);
}

_extern void _sub_5CA020(char const *);
...
_extern void _sub_5CA15B(float, float, float);
void NonDtmLoad::setSensorsThreshold(float startDist, float endDist, float dimValue) // 0x5CA15B
{
    ...
    todo("implement");
    _sub_5CA15B(startDist, endDist, dimValue);
}

_extern void _sub_5C7A5E(LuaBinding::ObjInternal1<vector3,void,LuaBinding::Functor1Free<vector3,void> > *const);
...
_extern void _sub_5C7A64(LuaBinding::ObjInternal1<vector4,void,LuaBinding::Functor1Free<vector4,void> > *const);
...
_extern void _sub_5C7A6A(LuaBinding::ObjInternal2<float,float,void,LuaBinding::Functor2Free<float,float,void> > *const);
...
_extern void _sub_5C7A70(LuaBinding::ObjInternal2<char const *,char const *,void,LuaBinding::Functor2Free<char const *,char const *,void> > *const);
...
_extern void _sub_5C7A76(LuaBinding::ObjInternal2<char const *,vector3,void,LuaBinding::Functor2Free<char const *,vector3,void> > *const);
...
_extern void _sub_5C7A7C(LuaBinding::ObjInternal2<vector3,vector3,void,LuaBinding::Functor2Free<vector3,vector3,void> > *const);
...
_extern void _sub_5C7A82(LuaBinding::ObjInternal3<float,float,float,void,LuaBinding::Functor3Free<float,float,float,void> > *const);
...
_extern void _sub_5C7A88(LuaBinding::ObjInternal3<char const *,vector3,float,void,LuaBinding::Functor3Free<char const *,vector3,float,void> > *const);
...
_extern void _sub_5C7A8E(LuaBinding::ObjInternal3<char const *,vector3,vector3,void,LuaBinding::Functor3Free<char const *,vector3,vector3,void> > *const);
...
_extern void _sub_5C7A94(LuaBinding::ObjInternal4<char const *,vector3,int,vector3,void,LuaBinding::Functor4Free<char const *,vector3,int,vector3,void> > *const);
...
_extern void _sub_5C7A9A(LuaBinding::ObjInternal5<char const *,vector3,float,float,float,void,LuaBinding::Functor5Free<char const *,vector3,float,float,float,void> > *const);
...
_extern void _sub_5C7AA0(LuaBinding::ObjInternal6<char const *,char const *,vector3,vector4,float,float,void,LuaBinding::Functor6Free<char const *,char const *,vector3,vector4,float,float,void> > *const);
...
_extern void _sub_5C7AA6(LuaBinding::ObjInternal6<char const *,vector3,float,float,float,float,void,LuaBinding::Functor6Free<char const *,vector3,float,float,float,float,void> > *const);
...
_extern void _sub_5C7AAC(LuaBinding::ObjInternal7<char const *,char const *,vector3,int,vector3,unsigned int,bool,void,LuaBinding::Functor7Free<char const *,char const *,vector3,int,vector3,unsigned int,bool,void> > *const);
...
_extern void _sub_5C7AB2(LuaBinding::ObjInternal7<char const *,vector3,float,float,float,float,int,void,LuaBinding::Functor7Free<char const *,vector3,float,float,float,float,int,void> > *const);
...
_extern void _sub_5C7AB8(LuaBinding::ObjInternal8<char const *,int,int,vector3,float,float,float,char const *,void,LuaBinding::Functor8Free<char const *,int,int,vector3,float,float,float,char const *,void> > *const);
