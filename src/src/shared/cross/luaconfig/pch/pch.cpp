...
extern std::locale::id std::num_put<char,std::back_insert_iterator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::id; // 0x1000C1D8
extern std::locale::id std::num_put<wchar_t,std::back_insert_iterator<std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t> > > >::id; // 0x1000C1DC
extern std::_Generic_error_category std::_Error_objects<int>::_Generic_object; // 0x1000C0E0
extern std::_Iostream_error_category std::_Error_objects<int>::_Iostream_object; // 0x1000C0E4
extern std::_System_error_category std::_Error_objects<int>::_System_object; // 0x1000C0E8
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhszivwUofzxlmurtUivovzhvUlyqUkxsOlyq@9608B38B3E11A9E8; // 0x1000C1D0

/* ---------- private variables */

_static
{
    extern std::_Ignore ignore; // 0x1000C1D5
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x1000C1D4
    extern std::piecewise_construct_t piecewise_construct; // 0x1000C1D7
    extern std::allocator_arg_t allocator_arg; // 0x1000C1D6
}
