...
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhlfixvUhvuwzfwrlUivovzhvUlyqUkxsOlyq@B84460423E7D8914; // 0x1000F98C

/* ---------- private variables */

_static
{
    extern std::piecewise_construct_t piecewise_construct; // 0x1000F993
    extern std::_Ignore ignore; // 0x1000F991
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x1000F990
    extern std::allocator_arg_t allocator_arg; // 0x1000F992
}
