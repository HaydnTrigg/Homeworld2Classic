...
_extern Net::Message::Type _sub_461825(Net::Message const *const);
_inline Net::Message::Type Net::Message::GetType() const // 0x461825
{
    mangled_assert("?GetType@Message@Net@@QBE?AW4Type@12@XZ");
    todo("implement");
    Net::Message::Type __result = _sub_461825(this);
    return __result;
}

_extern unsigned long _sub_4617E2(Net::Message const *const);
_inline unsigned long Net::Message::GetPlayerID() const // 0x4617E2
{
    mangled_assert("?GetPlayerID@Message@Net@@QBEKXZ");
    todo("implement");
    unsigned long __result = _sub_4617E2(this);
    return __result;
}

_extern std::vector<unsigned char,std::allocator<unsigned char> > const &_sub_461770(Net::Message const *const);
_inline std::vector<unsigned char,std::allocator<unsigned char> > const &Net::Message::GetData() const // 0x461770
{
    ...
    todo("implement");
    std::vector<unsigned char,std::allocator<unsigned char> > const & __result = _sub_461770(this);
    return __result;
}

_extern _sub_460627(Net::Message *const, Net::Message::Type);
_inline Net::Message::Message(Net::Message::Type) // 0x460627
{
    mangled_assert("??0Message@Net@@QAE@W4Type@01@@Z");
    todo("implement");
    _sub_460627(this, arg);
}

_extern _sub_6D1D87(Net::Message *const, Net::Message::Type, unsigned long);
_inline Net::Message::Message(Net::Message::Type, unsigned long) // 0x6D1D87
{
    mangled_assert("??0Message@Net@@QAE@W4Type@01@K@Z");
    todo("implement");
    _sub_6D1D87(this, arg, arg);
}

_extern _sub_6D1DB3(Net::Message *const, Net::Message::Type, unsigned long, std::vector<unsigned char,std::allocator<unsigned char> > &);
_inline Net::Message::Message(Net::Message::Type, unsigned long, std::vector<unsigned char,std::allocator<unsigned char> > &) // 0x6D1DB3
{
    ...
    todo("implement");
    _sub_6D1DB3(this, arg, arg, arg);
}

_extern void _sub_6D4D8A(Net::Message *const, Net::Message &);
_inline void Net::Message::swap(Net::Message &) // 0x6D4D8A
{
    mangled_assert("?swap@Message@Net@@QAEXAAV12@@Z");
    todo("implement");
    _sub_6D4D8A(this, arg);
}

_extern void _sub_6D4DB6(Net::Message &, Net::Message &);
