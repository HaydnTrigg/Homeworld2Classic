...
_extern _sub_53FF91(IdleState *const, CpuSquadGroup &);
_inline IdleState::IdleState(CpuSquadGroup &) // 0x53FF91
{
    mangled_assert("??0IdleState@@QAE@AAVCpuSquadGroup@@@Z");
    todo("implement");
    _sub_53FF91(this, arg);
}

_extern void _sub_540082(IdleState *const);
