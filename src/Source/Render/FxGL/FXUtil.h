...
_extern bool _sub_6E5C41(InterpolateLess2P<std::pair<float,float>,float> const *const, std::pair<float,float> const &, float const &);
_inline bool InterpolateLess2P<std::pair<float,float>,float>::operator()(std::pair<float,float> const &, float const &) const // 0x6E5C41
{
    ...
    todo("implement");
    bool __result = _sub_6E5C41(this, arg, arg);
    return __result;
}

_extern bool _sub_6E5C58(InterpolateLess2P<std::pair<float,vector3>,float> const *const, std::pair<float,vector3> const &, float const &);
_inline bool InterpolateLess2P<std::pair<float,vector3>,float>::operator()(std::pair<float,vector3> const &, float const &) const // 0x6E5C58
{
    ...
    todo("implement");
    bool __result = _sub_6E5C58(this, arg, arg);
    return __result;
}

_extern bool _sub_6E5C6F(InterpolateLess2P<std::pair<float,vector4>,float> const *const, std::pair<float,vector4> const &, float const &);
_inline bool InterpolateLess2P<std::pair<float,vector4>,float>::operator()(std::pair<float,vector4> const &, float const &) const // 0x6E5C6F
{
    ...
    todo("implement");
    bool __result = _sub_6E5C6F(this, arg, arg);
    return __result;
}

_extern unsigned __int32 _sub_6E383B(std::vector<std::pair<float,float>,std::allocator<std::pair<float,float> > > const &, float const);
_inline unsigned __int32 FindCurrentFrameTime<float>(std::vector<std::pair<float,float>,std::allocator<std::pair<float,float> > > const &v, float const age) // 0x6E383B
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_6E383B(v, age);
    return __result;
}

_extern unsigned __int32 _sub_6E386C(std::vector<std::pair<float,vector3>,std::allocator<std::pair<float,vector3> > > const &, float const);
_inline unsigned __int32 FindCurrentFrameTime<vector3>(std::vector<std::pair<float,vector3>,std::allocator<std::pair<float,vector3> > > const &v, float const age) // 0x6E386C
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_6E386C(v, age);
    return __result;
}

_extern unsigned __int32 _sub_6E389D(std::vector<std::pair<float,vector4>,std::allocator<std::pair<float,vector4> > > const &, float const);
_inline unsigned __int32 FindCurrentFrameTime<vector4>(std::vector<std::pair<float,vector4>,std::allocator<std::pair<float,vector4> > > const &v, float const age) // 0x6E389D
{
    ...
    todo("implement");
    unsigned __int32 __result = _sub_6E389D(v, age);
    return __result;
}

_extern float _sub_6E3593(float const &, float const &, float);
_inline float FXInterpolate<float>(float const &l, float const &r, float t) // 0x6E3593
{
    mangled_assert("??$FXInterpolate@M@@YGMABM0M@Z");
    todo("implement");
    float __result = _sub_6E3593(l, r, t);
    return __result;
}

_extern vector3 _sub_6E35DD(vector3 const &, vector3 const &, float);
_inline vector3 FXInterpolate<vector3>(vector3 const &l, vector3 const &r, float t) // 0x6E35DD
{
    ...
    todo("implement");
    vector3 __result = _sub_6E35DD(l, r, t);
    return __result;
}

_extern vector4 _sub_6E3663(vector4 const &, vector4 const &, float);
_inline vector4 FXInterpolate<vector4>(vector4 const &l, vector4 const &r, float t) // 0x6E3663
{
    ...
    todo("implement");
    vector4 __result = _sub_6E3663(l, r, t);
    return __result;
}

_extern float _sub_6E36D4(std::vector<std::pair<float,float>,std::allocator<std::pair<float,float> > > const &, float);
_inline float FXInterpolateTime<float>(std::vector<std::pair<float,float>,std::allocator<std::pair<float,float> > > const &v, float ageNormalized) // 0x6E36D4
{
    ...
    todo("implement");
    float __result = _sub_6E36D4(v, ageNormalized);
    return __result;
}

_extern vector3 _sub_6E372C(std::vector<std::pair<float,vector3>,std::allocator<std::pair<float,vector3> > > const &, float);
_inline vector3 FXInterpolateTime<vector3>(std::vector<std::pair<float,vector3>,std::allocator<std::pair<float,vector3> > > const &v, float ageNormalized) // 0x6E372C
{
    ...
    todo("implement");
    vector3 __result = _sub_6E372C(v, ageNormalized);
    return __result;
}

_extern vector4 _sub_6E378B(std::vector<std::pair<float,vector4>,std::allocator<std::pair<float,vector4> > > const &, float);
_inline vector4 FXInterpolateTime<vector4>(std::vector<std::pair<float,vector4>,std::allocator<std::pair<float,vector4> > > const &v, float ageNormalized) // 0x6E378B
{
    ...
    todo("implement");
    vector4 __result = _sub_6E378B(v, ageNormalized);
    return __result;
}

_extern float _sub_6E1465(vector3 const &, float, float);
_inline float FXCalculateDragFactor(vector3 const &vel, float drag, float elapsedSeconds) // 0x6E1465
{
    ...
    todo("implement");
    float __result = _sub_6E1465(vel, drag, elapsedSeconds);
    return __result;
}
