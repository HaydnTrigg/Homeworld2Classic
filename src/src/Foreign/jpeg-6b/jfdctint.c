...
extern void jpeg_fdct_islow(__int32 *data);
...
_extern void _sub_100D5460(__int32 *);
void jpeg_fdct_islow(__int32 *data) // 0x100D5460
{
    mangled_assert("_jpeg_fdct_islow@4");
    todo("implement");
    _sub_100D5460(data);
}
