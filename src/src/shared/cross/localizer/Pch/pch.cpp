...
typedef boost::mpl::bool_<0> false_;
typedef boost::mpl::bool_<1> true_;
...
extern std::locale::id std::num_put<char,std::back_insert_iterator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::id; // 0x100112D8
extern std::locale::id std::num_put<wchar_t,std::back_insert_iterator<std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t> > > >::id; // 0x100112DC
extern __int32 __@@_PchSym_@00@UsrxplibRkxhsrkUslnvdliowCxozhhrxUhixUrmgvinvwrzgvUhszivwUolxzoraviUivovzhvUlyqUkxsOlyq@5DD7BEB794714209; // 0x100112D0
extern std::_Generic_error_category std::_Error_objects<int>::_Generic_object; // 0x1000D1A0
extern std::_Iostream_error_category std::_Error_objects<int>::_Iostream_object; // 0x1000D1A4
extern std::_System_error_category std::_Error_objects<int>::_System_object; // 0x1000D1A8

/* ---------- private variables */

_static
{
    extern std::_Ignore ignore; // 0x100112D5
    extern std::_Tuple_alloc_t _Tuple_alloc; // 0x100112D4
    extern std::piecewise_construct_t piecewise_construct; // 0x100112D7
    extern std::allocator_arg_t allocator_arg; // 0x100112D6
}

/* ---------- public code */

_extern void _sub_10008948(std::_Generic_error_category *const);
_inline std::_Generic_error_category::~_Generic_error_category() // 0x10008948
{
...
_extern void _sub_1000894F(std::_Iostream_error_category *const);
_inline std::_Iostream_error_category::~_Iostream_error_category() // 0x1000894F
{
...
_extern void _sub_10008956(std::_System_error_category *const);
_inline std::_System_error_category::~_System_error_category() // 0x10008956
{
