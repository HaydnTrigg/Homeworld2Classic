...
_extern bool _sub_100B8E80();
bool StateBlockManager::startup() // 0x100B8E80
{
    mangled_assert("?startup@StateBlockManager@@SG_NXZ");
    todo("implement");
    bool __result = _sub_100B8E80();
    return __result;
}

_extern _sub_100B57D0(StateBlockManager::Data *const);
...
_extern void _sub_100B5980(std::_List_buy<std::pair<std::basic_string<char,std::char_traits<char>,std::allocator<char> > const ,CompoundStateBlock *>,std::allocator<std::pair<std::basic_string<char,std::char_traits<char>,std::allocator<char> > const ,CompoundStateBlock *> > > *const);
...
_extern void _sub_100B59C0(std::_Tree_buy<std::pair<unsigned long const ,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >,std::allocator<std::pair<unsigned long const ,std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > *const);
...
_extern void _sub_100B59D0(std::_Tree_comp<0,std::_Tmap_traits<unsigned long,std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >,0> > *const);
...
_extern void _sub_100B5A50(std::map<unsigned long,std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::less<unsigned long>,std::allocator<std::pair<unsigned long const ,std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > > *const);
...
_extern void _sub_100B5A70(std::pair<unsigned long const ,std::basic_string<char,std::char_traits<char>,std::allocator<char> > > *const);
...
_extern void _sub_100B5AA0(std::pair<std::basic_string<char,std::char_traits<char>,std::allocator<char> > const ,CompoundStateBlock *> *const);
...
_extern void _sub_100B5AD0(std::pair<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,CompoundStateBlock *> *const);
...
_extern void _sub_100B5B00(boost::detail::sp_counted_base_impl<StateCommandBlock *,boost::checked_deleter<StateCommandBlock> > *const);
...
_extern void _sub_100B5B70(StateBlockManager::Data *const);
...
_extern void _sub_100B5C10(StateBlockManager *const);
...
_extern void _sub_100B5BF0(Dictionary *const);
...
_extern bool _sub_100B8E30(StateBlockManager const *const);
bool StateBlockManager::singlePassShadows() const // 0x100B8E30
{
    mangled_assert("?singlePassShadows@StateBlockManager@@QBE_NXZ");
    todo("implement");
    bool __result = _sub_100B8E30(this);
    return __result;
}

_extern void _sub_100B7110(StateBlockManager *const, rndTable *);
void StateBlockManager::attachGL(rndTable *) // 0x100B7110
{
    mangled_assert("?attachGL@StateBlockManager@@QAEXPAUrndTable@@@Z");
    todo("implement");
    _sub_100B7110(this, arg);
}

_extern unsigned long _sub_100B8680(StateBlockManager *const, char const *);
unsigned long StateBlockManager::getVariableKey(char const *) // 0x100B8680
{
    ...
    todo("implement");
    unsigned long __result = _sub_100B8680(this, arg);
    return __result;
}

_extern rndTable *_sub_100B8660(StateBlockManager const *const);
rndTable *StateBlockManager::getGL() const // 0x100B8660
{
    mangled_assert("?getGL@StateBlockManager@@QBEPAUrndTable@@XZ");
    todo("implement");
    rndTable * __result = _sub_100B8660(this);
    return __result;
}

_extern CompoundStateBlock *_sub_100B8670(StateBlockManager const *const);
CompoundStateBlock *StateBlockManager::getOverrideBlock() const // 0x100B8670
{
    ...
    todo("implement");
    CompoundStateBlock * __result = _sub_100B8670(this);
    return __result;
}

_extern boost::shared_ptr<StateCommandBlock> _sub_100B7E60(StateBlockManager *const);
boost::shared_ptr<StateCommandBlock> StateBlockManager::createStateBlock() // 0x100B7E60
{
    ...
    todo("implement");
    boost::shared_ptr<StateCommandBlock> __result = _sub_100B7E60(this);
    return __result;
}

_extern boost::shared_ptr<StateCommandBlock> _sub_100B8840(StateBlockManager *const, char const *, char const *);
boost::shared_ptr<StateCommandBlock> StateBlockManager::loadStateBlock(char const *, char const *) // 0x100B8840
{
    ...
    todo("implement");
    boost::shared_ptr<StateCommandBlock> __result = _sub_100B8840(this, arg, arg);
    return __result;
}

_extern CompoundStateBlock *_sub_100B8480(StateBlockManager *const, char const *, char const *);
CompoundStateBlock *StateBlockManager::findCompoundStateBlock(char const *, char const *) // 0x100B8480
{
    ...
    todo("implement");
    CompoundStateBlock * __result = _sub_100B8480(this, arg, arg);
    return __result;
}

_extern CompoundStateBlock *_sub_100B8710(StateBlockManager *const, char const *, char const *);
CompoundStateBlock *StateBlockManager::loadCompoundStateBlock(char const *, char const *) // 0x100B8710
{
    ...
    todo("implement");
    CompoundStateBlock * __result = _sub_100B8710(this, arg, arg);
    return __result;
}

_extern void _sub_100B8DF0(StateBlockManager *const, CompoundStateBlock *);
void StateBlockManager::setOverrideBlock(CompoundStateBlock *) // 0x100B8DF0
{
    ...
    todo("implement");
    _sub_100B8DF0(this, arg);
}

_extern void _sub_100B7580(StateBlockManager *const);
...
_extern void _sub_100B8C70(StateBlockManager *const);
...
_extern boost::shared_ptr<StateCommandBlock> _sub_100B75D0(StateBlockManager const *const, StateCommandBlock const *);
boost::shared_ptr<StateCommandBlock> StateBlockManager::createInverseBlock(StateCommandBlock const *) const // 0x100B75D0
{
    ...
    todo("implement");
    boost::shared_ptr<StateCommandBlock> __result = _sub_100B75D0(this, arg);
    return __result;
}

/* ---------- private code */

_extern void _sub_100B7390(char const *, std::vector<char const *,std::allocator<char const *> >, char const *, char *, unsigned __int32);
_static void buildFilename(char const *name, std::vector<char const *,std::allocator<char const *> > directory, char const *loc, char *output, unsigned __int32 len) // 0x100B7390
{
    ...
    todo("implement");
    _sub_100B7390(name, directory, loc, output, len);
}

_extern __int32 _sub_100B8610(StateCommand *, rndTable *);
_static __int32 getFuncId(StateCommand *com, rndTable *gl) // 0x100B8610
{
    mangled_assert("getFuncId");
    todo("implement");
    __int32 __result = _sub_100B8610(com, gl);
    return __result;
}
#endif
