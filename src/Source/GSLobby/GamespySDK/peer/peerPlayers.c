...
_extern PEERBool _sub_10014FB6(void *);
PEERBool piPlayersInit(void *peer) // 0x10014FB6
{
    mangled_assert("_piPlayersInit@4");
    todo("implement");
    PEERBool __result = _sub_10014FB6(peer);
    return __result;
}

_extern void _sub_10014F82(void *);
...
_extern piPlayer *_sub_10014EA9(void *, char const *, RoomType, __int32);
piPlayer *piPlayerJoinedRoom(void *peer, char const *nick, RoomType roomType, __int32 mode) // 0x10014EA9
{
    ...
    todo("implement");
    piPlayer * __result = _sub_10014EA9(peer, nick, roomType, mode);
    return __result;
}

_extern void _sub_10014F27(void *, char const *, RoomType);
void piPlayerLeftRoom(void *peer, char const *nick, RoomType roomType) // 0x10014F27
{
    mangled_assert("_piPlayerLeftRoom@12");
    todo("implement");
    _sub_10014F27(peer, nick, roomType);
}

_extern void _sub_10014E3E(void *, char const *, char const *);
void piPlayerChangedNick(void *peer, char const *oldNick, char const *newNick) // 0x10014E3E
{
    ...
    todo("implement");
    _sub_10014E3E(peer, oldNick, newNick);
}

_extern void _sub_10014C17(void *, RoomType);
void piClearRoomPlayers(void *peer, RoomType roomType) // 0x10014C17
{
    mangled_assert("_piClearRoomPlayers@8");
    todo("implement");
    _sub_10014C17(peer, roomType);
}

_extern piPlayer *_sub_10014D4E(void *, char const *);
piPlayer *piGetPlayer(void *peer, char const *nick) // 0x10014D4E
{
    mangled_assert("_piGetPlayer@8");
    todo("implement");
    piPlayer * __result = _sub_10014D4E(peer, nick);
    return __result;
}

_extern void _sub_10014C94(void *, void *);
void piEnumRoomPlayersMap(void *elem, void *clientdata) // 0x10014C94
{
    mangled_assert("_piEnumRoomPlayersMap@8");
    todo("implement");
    _sub_10014C94(elem, clientdata);
}

_extern void _sub_10014C40(void *, RoomType, void (*)(void *, RoomType, piPlayer *, __int32, void *), void *);
void piEnumRoomPlayers(void *peer, RoomType roomType, void (*callback)(void *, RoomType, piPlayer *, __int32, void *), void *param) // 0x10014C40
{
    ...
    todo("implement");
    _sub_10014C40(peer, roomType, callback, param);
}

_extern __int32 _sub_10014D2F(void *, void *);
__int32 piFindPlayersByIPMap(void *elem, void *clientdata) // 0x10014D2F
{
    mangled_assert("_piFindPlayersByIPMap@8");
    todo("implement");
    __int32 __result = _sub_10014D2F(elem, clientdata);
    return __result;
}

_extern piPlayer *_sub_10014CBB(void *, unsigned __int32);
piPlayer *piFindPlayerByIP(void *peer, unsigned __int32 IP) // 0x10014CBB
{
    mangled_assert("_piFindPlayerByIP@8");
    todo("implement");
    piPlayer * __result = _sub_10014CBB(peer, IP);
    return __result;
}

_extern void _sub_1001509A(void *, char const *, unsigned __int32, __int32);
void piSetPlayerIPAndProfileID(void *peer, char const *nick, unsigned __int32 IP, __int32 profileID) // 0x1001509A
{
    ...
    todo("implement");
    _sub_1001509A(peer, nick, IP, profileID);
}

_extern __int32 _sub_10014DE9(char const *);
__int32 piParseFlags(char const *flags) // 0x10014DE9
{
    mangled_assert("_piParseFlags@4");
    todo("implement");
    __int32 __result = _sub_10014DE9(flags);
    return __result;
}

_extern void _sub_10015151(void *, char const *, RoomType, char const *);
void piSetPlayerRoomFlags(void *peer, char const *nick, RoomType roomType, char const *flags) // 0x10015151
{
    ...
    todo("implement");
    _sub_10015151(peer, nick, roomType, flags);
}

_extern void _sub_10015105(void *, char const *, RoomType, __int32);
...
_extern piPlayer *_sub_10014B7C(void *, char const *, PEERBool);
_static piPlayer *piAddPlayer(void *peer, char const *nick, PEERBool initialize) // 0x10014B7C
{
    mangled_assert("piAddPlayer");
    todo("implement");
    piPlayer * __result = _sub_10014B7C(peer, nick, initialize);
    return __result;
}

_extern void _sub_10014DCB(void *, void *);
_static void piLeftRoomMapFn(void *elem, void *clientdata) // 0x10014DCB
{
    mangled_assert("piLeftRoomMapFn");
    todo("implement");
    _sub_10014DCB(elem, clientdata);
}

_extern void _sub_1001502C(void *, char const *, RoomType, __int32);
_static void piSetNewPlayerFlags(void *peer, char const *nick, RoomType roomType, __int32 flags) // 0x1001502C
{
    ...
    todo("implement");
    _sub_1001502C(peer, nick, roomType, flags);
}
#endif
