...
_extern void _sub_10015988(std::_Generic_error_category *const);
...
_extern void _sub_1001598F(std::_Iostream_error_category *const);
...
_extern void _sub_10015996(std::_System_error_category *const);
